...
const exactEnglish = {
  editor: {
    ...
    toolbar: {
      ...
      exportScope: "匯出範圍",
      currentView: "目前檢視",
      allDatabaseMembers: "所有集合項目",
      allDatabaseMembersDetail: "此集合中的每個頁面",
      exportColumns: "匯出欄位",
      exportProperties: "屬性",
  ...
  sidebar: {
    ...
    localFolder: "本機資料夾",
    newWorkspace: "新增工作區",
    newWorkspaceDescription: "建立一個擁有專屬 Files 集合的私人工作區。",
    workspaceName: "工作區名稱",
...
const overrides = {
  ...
  root: {
    ...
    searchAnyDate: "任何日期",
    searchPastWeek: "過去一週",
    searchPastMonth: "過去一個月",
    searchPrevious: "上一頁結果",
    searchNext: "下一頁結果",
    searchRetry: "重試",
    searchScopeUnavailable: "搜尋範圍無法使用。",
    searchModified: "修改於 {{date}}",
    searchSourceUpdated: "來源更新於 {{date}}",
    commandSearchPlaceholder: "搜尋文件和集合...",
    commandSearchLoading: "搜尋中...",
    commandSearchError: "搜尋目前無法使用。",
    commandSearchPartialError: "部分結果無法載入。",
    commandSearchEmpty: "沒有相符的文件或集合。",
    commandDocumentsHeading: "文件",
    commandDatabasesHeading: "集合",
    commandLocalFilesHeading: "本機檔案",
    commandDatabaseResultDescription: "開啟集合頁面",
  ...
  editor: {
    ...
    enterToSubmit: "輸入提交",
    failedToCreateDatabase: "建立內嵌集合失敗",
    ...
    openLink: "開啟連結",
    removeLink: "移除連結",
    historyCheckpointAfter: "之後",
    historyCheckpointBefore: "之前",
    historyCheckpointLegacy: "已儲存",
    historyCheckpointLoadError: "無法載入檢查點。",
    historyDetailLoadError: "無法載入此檢查點。",
    historyGroupAgent: "代理執行",
    historyGroupHuman: "編輯工作階段",
    historyGroupLegacy: "較早的編輯",
    historyGroupOperation: "操作",
    historyGroupRestore: "還原",
    historyLoadError: "無法載入版本歷史紀錄。",
    historyLoadMore: "載入更多",
    historyLinkedLocalRestoreUnavailable:
      "此處無法還原已連結的本機檔案。檔案不會變更。",
    historyLoadingMore: "正在載入…",
    historyPreparingRestore: "正在儲存目前狀態…",
    historyRefreshing: "正在重新整理歷史紀錄…",
    historyRestoreUnavailable: "請先儲存此頁面再還原歷史紀錄。",
    historyRetry: "重試",
    historySaveBeforeRestoreFailed: "還原前無法儲存目前狀態。",
    historyShowingSavedResults: "無法重新整理。正在顯示已儲存的歷史紀錄。",
    ...
    historyRestoreAppliedRefreshFailed:
      "還原已儲存，但編輯器無法重新整理。請重新載入此頁面。",
    versionRestoreWarning:
      "還原會取代此頁面的標題和內文，對所有人可見。目前狀態會保留在歷史記錄中。",
    ...
    properties: {
      ...
      addDatabaseDescription: "新增此集合的說明…",
  ...
  database: {
    ...
    formDescription: "填寫以下問題，將頁面新增至此集合。",
    ...
    formSubmitted: "回覆已提交",
    formSubmittedDescription: "新的集合頁面已準備完成。",
    formSubmitting: "提交中...",
    addARowTo: "新增列至…",
    addASource: "新增來源",
    aField: "一個欄位",
    ...
    addingItems: "正在新增項目",
    addingItemsAsRows: "正在將項目新增為此集合中的獨立列。",
    ...
    chooseFields: "選擇欄位",
    pickDetailsBecomeColumns: "選擇哪些詳細資料應成為集合欄位。",
    ...
    failedToRemoveEverySelectedRowFromDatabase: "無法從集合中移除所有選取行",
    failedToRemoveRowFromDatabase: "無法從集合中移除該行",
    removeSelectedRowsFromDatabaseQuestion: "從集合中移除選取行？",
    removeSelectedRowsFromDatabaseDescription:
      "所選頁面仍可在「檔案」和其他集合中使用。僅屬於此集合的值將被移除。",
    removeFromDatabase: "從集合中移除",
    removeFromDatabaseQuestion: "從集合中移除？",
    removeFromDatabaseDescription:
      "「{{title}}」仍可在「檔案」和其他集合中使用。僅屬於此集合的值將被移除。",
    remove: "移除",
    removing: "正在移除...",
    ...
    newDatabaseGalleryCardTitle: "新集合畫廊卡片標題",
    newDatabaseListItemTitle: "新集合清單項標題",
    newDatabaseRow: "新集合行",
    newGroup: "新分組",
    newPage: "新頁面",
    newProperty: "新屬性",
    newViewName: "新檢視名稱",
    nextDatabasePage: "下一頁面集合頁面",
    nextMonth: "下個月",
    ...
    noDatabasePageSelected: "未選取集合頁面。",
    noDate: "無日期",
    ...
    noOtherDatabasesAvailableToAdd: "沒有其他可新增的集合。",
    ...
    keepTheDatabaseRowsAndLocalPropertiesButRemoveSource:
      "保留集合行和本機屬性，但移除來源對應、行識別和待處理來源更改。",
    latest: "Latest",
    max: "Max",
    median: "Median",
    min: "Min",
