...
const messages = {
  ...
  comments: {
    ...
    updateFailed: "यह टिप्पणी अपडेट नहीं की जा सकी।",
    deleteFailed: "यह टिप्पणी हटाई नहीं जा सकी।",
    reactionFailed: "यह प्रतिक्रिया अपडेट नहीं की जा सकी।",
    addCommentPlaceholder: "टिप्पणी जोड़ें...",
    addReaction: "प्रतिक्रिया जोड़ें",
    toggleReaction: "{{emoji}} प्रतिक्रिया बदलें",
    reactWith: "{{emoji}} से प्रतिक्रिया दें",
    cancel: "रद्द करें",
    ...
    audience: "टिप्पणी दर्शक",
    all: "सभी",
    forYou: "आपके लिए",
    goToSlide: "स्लाइड पर जाएं",
    search: "टिप्पणियां खोजें",
    searchPlaceholder: "सभी टिप्पणियां खोजें...",
  },
  styleInspector: {
    title: "Style",
