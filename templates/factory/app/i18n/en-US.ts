const messages = {
  ...
  triage: {
    ...
    inboxColumnAutomation: "Automation",
    inboxRouting: {
      received: "Received",
      context_fetching: "Fetching context",
      evidence_ready: "Evidence ready",
    ...
    inboxPhase: {
      ...
      slack: {
        ...
        builder_notified: "Builder notified",
        new: "New",
      },
    },
    refresh: "Refresh",
  ...
  factoryRoute: {
    ...
    auditViewMore: "View more",
    auditViewLess: "View less",
    ...
    auditBabysitRecommendation: "Recommendation",
    auditBabysitDecision: "Decision",
    auditBabysitAgentMismatch: "Overrode recommendation",
    auditBabysitOpenBotThreads: "Open bot threads",
    auditBabysitOpenHumanThreads: "Open human threads",
    auditBabysitBuilderActive: "Builder active",
    auditBabysitCiBlocking: "Blocking CI",
    ...
    auditOutcomeHeld: "Skipped",
    auditOutcomeDispatched: "Started",
    auditOutcomeFailed: "Dispatch failed",
    auditOutcomeInspected: "Opened",
    auditOutcomeLeft: "Left",
    auditSectionInbox: "Add to inbox",
    auditSectionWork: "Work on this run",
    auditSectionActions: "Actions taken",
    auditAdded: "{{count}} added",
    auditListed: "{{count}} listed",
    ...
    automationCreateRefreshFailed:
      "Created, but the list did not refresh. Stay here or open Automations again.",
    ...
    automationConnectDescription:
      "Connect this source in Dispatch integrations, then return here.",
    automationMissingSlack: "Slack is not connected in Dispatch",
    automationMissingGithub: "GitHub is not connected in Dispatch",
    automationMissingSentry: "Sentry is not connected in Dispatch",
    automationReadinessUnavailable:
      "Couldn't confirm the connector. Retry in a moment.",
    ...
    automationInboxLimitDescription:
      "The number of new items this job may add to the inbox per run. Maximum 50.",
    automationWorkLimit: "Work per run",
    automationWorkLimitDescription:
      "The number of items the agent works on per run. Maximum 10.",
    automationGuardrails: "Guardrails",
    automationSkillAlignment: "Skill alignment",
    ...
    automationNotFound: "That automation no longer exists.",
    ...
    saveAutomation: "Save",
    automationUnsavedChanges: "Unsaved automation changes",
    automationDiscardChanges: "Discard",
    automationCurrentSaved: "Current (saved)",
    automationCurrentSavedShort: "Version {{version}}",
    automationNoSavedVersions: "No saved versions",
    ...
    automationVersionRowDetail: "v{{promptVersion}} · saved {{savedAt}}",
    automationVersionDeleteLabel: "Delete this version",
    automationVersionDeleteTitle: "Delete {{label}}?",
    automationVersionDeleteWarning: "This can't be undone.",
    automationVersionDeleteCancel: "Cancel",
    automationVersionDeleteConfirm: "Delete version",
    automationVersionDeleted: "Version deleted.",
    automationVersionDeleteFailed: "Could not delete that version.",
    automationSaved: "Saved",
    automationSaveFailed: "Could not save the automation.",
    automationRunFailed: "Could not run the automation.",
    automationRunNeedsSave: "Save your changes before running this automation.",
