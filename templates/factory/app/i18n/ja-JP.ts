const messages = {
  ...
  triage: {
    ...
    inboxPhase: {
      ...
      slack: {
        claimed: "対応中",
        agent_running: "エージェント実行中",
        evidence_ready: "根拠の準備完了",
        needs_human: "要対応",
        disposition: "処置設定済み",
        builder_notified: "Builder に通知済み",
        new: "新規",
      },
    },
    refresh: "更新",
  ...
  factoryRoute: {
    ...
    auditBabysitRecommendation: "推奨",
    auditBabysitDecision: "判断",
    auditBabysitAgentMismatch: "推奨を上書き",
    auditBabysitOpenBotThreads: "未解決の bot スレッド",
    auditBabysitOpenHumanThreads: "未解決の人間スレッド",
    auditBabysitBuilderActive: "Builder 稼働中",
    auditBabysitCiBlocking: "ブロック中の CI",
    auditBabysitVeto: "拒否",
    auditTrace: "トレース",
    auditRunPromptVersion: "プロンプト v{{version}}",
    auditRunPromptHash: "ハッシュ {{hash}}",
    auditWhy: "理由",
    ...
    auditOutcomeHeld: "スキップ",
    auditOutcomeDispatched: "開始済み",
    auditOutcomeFailed: "送信失敗",
    auditOutcomeInspected: "開いた",
    auditOutcomeLeft: "未処理",
    auditSectionInbox: "受信箱に追加",
    auditSectionWork: "この実行の作業",
    auditSectionActions: "実行した操作",
    auditAdded: "{{count}} 件追加",
    auditListed: "{{count}} 件表示",
    ...
    automationInboxLimitDescription:
      "1回の実行で受信箱に追加できる新規件数。最大 50。",
    automationWorkLimit: "実行あたりの作業",
    automationWorkLimitDescription:
      "1回の実行でエージェントが作業する件数。最大 10。",
    automationGuardrails: "ガードレール",
    automationSkillAlignment: "スキル整合",
    ...
    automationNotFound: "その自動化は存在しません。",
    automationModel: "モデル",
    ...
    saveAutomation: "保存",
    automationUnsavedChanges: "未保存のオートメーション変更",
    automationDiscardChanges: "破棄",
    automationCurrentSaved: "現在（保存済み）",
    automationCurrentSavedShort: "バージョン {{version}}",
    automationNoSavedVersions: "保存済みバージョンなし",
    automationVersionPickerLabel: "バージョン",
    ...
    automationVersionRowDetail: "v{{promptVersion}} · 保存 {{savedAt}}",
    automationVersionDeleteLabel: "このバージョンを削除",
    automationVersionDeleteTitle: "{{label}}を削除しますか?",
    automationVersionDeleteWarning: "この操作は元に戻せません。",
    automationVersionDeleteCancel: "キャンセル",
    automationVersionDeleteConfirm: "バージョンを削除",
    automationVersionDeleted: "バージョンを削除しました。",
    automationVersionDeleteFailed: "そのバージョンを削除できませんでした。",
    automationSaved: "保存しました",
    automationSaveFailed: "自動化を保存できませんでした。",
    automationRunFailed: "自動化を実行できませんでした。",
    automationRunNeedsSave: "この自動化を実行する前に変更を保存してください。",
