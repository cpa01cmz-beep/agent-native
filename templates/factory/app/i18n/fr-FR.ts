const messages = {
  ...
  triage: {
    ...
    inboxColumnAutomation: "Automatisation",
    inboxRouting: {
      received: "Reçu",
      context_fetching: "Récupération du contexte",
      evidence_ready: "Preuve prête",
    ...
    inboxPhase: {
      ...
      slack: {
        ...
        evidence_ready: "Preuve prête",
        needs_human: "Intervention humaine",
        disposition: "Disposition définie",
        builder_notified: "Builder notifié",
        new: "Nouveau",
      },
    },
    refresh: "Actualiser",
  ...
  factoryRoute: {
    ...
    auditViewMore: "Voir plus",
    auditViewLess: "Voir moins",
    ...
    auditBabysitRecommendation: "Recommandation",
    auditBabysitDecision: "Décision",
    auditBabysitAgentMismatch: "Recommandation ignorée",
    auditBabysitOpenBotThreads: "Fils bot ouverts",
    auditBabysitOpenHumanThreads: "Fils humains ouverts",
    auditBabysitBuilderActive: "Builder actif",
