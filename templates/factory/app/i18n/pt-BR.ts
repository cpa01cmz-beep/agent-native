const messages = {
  ...
  triage: {
    ...
    inboxColumnAutomation: "Automação",
    inboxRouting: {
      received: "Recebido",
      context_fetching: "Buscando contexto",
      evidence_ready: "Evidência pronta",
      classified: "Classificado",
      shadow_decided: "Decisão sombra",
      needs_manual: "Revisão necessária",
      failed: "Falhou",
      reconciliation_required: "Reconciliação necessária",
      automation_started: "Automação iniciada",
    ...
    inboxPhase: {
      babysit: {
        queued: "Na fila",
        waiting: "Aguardando",
        builder_active: "Builder ativo",
        stuck: "Travado",
        clean: "Limpo",
        ineligible: "Não elegível",
        merged: "Mesclado no GitHub",
        reopened: "Reaberto após atualização",
        mergeable_as_of:
          "Mergeável; a Factory não vai pingar o Builder de novo neste branch.",
      },
      slack: {
        claimed: "Reivindicado",
        agent_running: "Agente em execução",
        evidence_ready: "Evidência pronta",
  ...
  factoryRoute: {
    ...
    auditBabysitRecommendation: "Recomendação",
    auditBabysitDecision: "Decisão",
    auditBabysitAgentMismatch: "Ignorou a recomendação",
    auditBabysitOpenBotThreads: "Threads de bot abertos",
    auditBabysitOpenHumanThreads: "Threads humanos abertos",
    auditBabysitBuilderActive: "Builder ativo",
    ...
    auditOutcomeHeld: "Ignorado",
    auditOutcomeDispatched: "Iniciado",
    auditOutcomeFailed: "Envio falhou",
    auditOutcomeInspected: "Aberto",
    auditOutcomeLeft: "Deixado",
    auditSectionInbox: "Adicionar à caixa de entrada",
    auditSectionWork: "Trabalho desta execução",
    auditSectionActions: "Ações tomadas",
    auditAdded: "{{count}} adicionados",
    auditListed: "{{count}} listados",
    auditSkipped: "{{count}} ignorados",
    auditStartedCount: "{{count}} iniciados",
    auditSeenBefore: "Já visto",
    auditMergedOnGitHub: "Mesclado no GitHub",
    auditClosedOnGitHub: "Fechado no GitHub",
    auditDraftOnGitHub: "Rascunho no GitHub",
    auditNewThisRun: "Novo",
    auditAlreadyStarted: "Já iniciado",
    ...
    automationInboxLimitDescription:
      "Quantos itens novos este job pode adicionar à caixa por execução. Máximo 50.",
    automationWorkLimit: "Trabalho por execução",
