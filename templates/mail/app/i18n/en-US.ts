const messages = {
  ...
  mail: {
    ...
    aiFilter: {
      ...
      noMatch: "No match",
      feedbackPlaceholder:
        "Optional: tell AI what it misunderstood or what to look for instead",
      refineButton: "Update rule & rerun",
      instructionsUpdated: "Rule updated and preview rerun.",
      noRecentMail: "No recent Inbox mail to review.",
      addRuleToPreview: "Add an AI rule to preview recent mail.",
      previewEmpty: "Run a preview to see likely matches here.",
      previewFailed: "Could not preview recent mail.",
    },
    draftQueue: {
      title: "Draft queue",
