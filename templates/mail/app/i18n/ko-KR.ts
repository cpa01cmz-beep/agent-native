const messages = {
  ...
  mail: {
    ...
    aiFilter: {
      ...
      spamLabelHint:
        "일치하는 메일에 라벨을 지정하고 받은편지함 밖으로 이동합니다.",
      spamPlaceholder: "예: 명백한 홍보성 또는 원치 않는 메시지",
      tagPlaceholder: "예: 온라인 상점의 영수증 및 주문 확인",
      addShortcut: "⌘ Enter를 눌러 추가",
      ...
      noMatch: "일치 없음",
      feedbackPlaceholder:
        "선택사항: AI가 잘못 이해한 점이나 대신 찾아야 할 내용을 알려주세요",
      refineButton: "규칙 업데이트 및 다시 실행",
      instructionsUpdated: "규칙을 업데이트하고 미리보기를 다시 실행했습니다.",
      noRecentMail: "검토할 최근 받은편지함 메일이 없습니다.",
      addRuleToPreview: "최근 메일을 미리 보려면 AI 규칙을 추가하세요.",
      previewEmpty: "미리보기를 실행하면 일치 가능성이 표시됩니다.",
      previewFailed: "최근 메일을 미리 보지 못했습니다.",
    },
    draftQueue: {
