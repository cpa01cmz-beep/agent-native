...
export const TURN_INTO_APP_FRESH_PROJECT_REFERENCE_MD = `# Fresh Project source guide
...
export const TURN_INTO_APP_SPREADSHEET_SOURCE_REFERENCE_MD = `# Spreadsheet source review
