const messages = {
  ...
  agentPanel: {
    ...
    keyScope: "Escopo da chave",
    personalKeyScope: "Pessoal",
    organizationKeyScope: "Organização",
    personalKeyInEffect: "Sua chave pessoal está em uso.",
    organizationKeyInEffect: "A chave da organização está em uso.",
  ...
  org: {
    ...
    askAdminTitle: "Fale com seu administrador",
    askAdminDescription:
      "Peça a um administrador um convite para participar deste workspace.",
    ...
    appRolesOptional: "Funções do app",
    noAppRolesFound: "Nenhuma função encontrada",
    notAssigned: "Não atribuído",
    appPermissions: "Permissões do app",
    applications: "Aplicativos",
    applicationsEmpty: "Ainda não há aplicativos do workspace registrados.",
    applicationsLoadFailed:
      "Não foi possível carregar os aplicativos do workspace.",
    applicationAccess: "Acesso para {{name}}",
    applicationAccessAll: "Todos os membros",
    applicationAccessRestricted: "Restrito",
    applicationAccessDisabled: "Desativado",
    ...
    ssoConfirm: {
      title: "Exigir este provedor de login?",
      description:
        "Os membros precisarão usar este provedor no próximo login. As sessões atuais podem ser revogadas.",
      confirm: "Exigir provedor",
    },
    ssoSetup: {
      idpSetup: "Configuração do provedor de identidade",
      redirectUri: "URI de redirecionamento",
      spMetadataUrl: "URL de metadados do provedor de serviço",
      dnsRecordName: "Nome do registro DNS TXT",
      dnsRecordValue: "Valor do registro DNS TXT",
      dnsPropagation:
        "Aguarde a propagação das alterações DNS antes de verificar.",
    },
    sso: {
      signIn: "Login da organização",
      signInHelp: "Escolha o provedor de login obrigatório.",
      requiredProvider: "Provedor de login obrigatório",
      optional: "Opcional",
      google: "Google",
      title: "Login único",
      description: "Conecte um provedor de identidade OIDC ou SAML.",
      verified: "Verificado",
      verifyRequired: "Verificação necessária",
      verify: "Verificar",
      remove: "Remover",
      type: "Tipo de provedor de identidade",
      providerId: "ID do provedor",
      issuer: "URL do emissor",
      domain: "Domínio da organização",
      noDomain: "Nenhum domínio configurado",
      clientId: "ID do cliente",
      clientSecret: "Segredo do cliente",
      discoveryEndpoint: "Endpoint de descoberta (opcional)",
      entryPoint: "URL de entrada SAML",
      entityId: "ID da entidade IdP",
      metadata: "Cole o XML de metadados do IdP",
      certificate: "Certificado de assinatura (opcional)",
      domainHelp:
        "O domínio deve corresponder ao domínio verificado da organização. Segredos e metadados são apagados do formulário após o envio.",
      saveProvider: "Salvar provedor",
      cancel: "Cancelar",
      addProvider: "Adicionar provedor",
    },
    scim: {
      title: "Provisionamento de diretório",
      description: "Gerencie as conexões SCIM desta organização.",
      revoke: "Revogar",
      copyTokenOnce: "Copie este token agora. Ele não será exibido novamente.",
      dismissToken: "Ocultar token",
      createConnection: "Criar conexão SCIM",
    },
