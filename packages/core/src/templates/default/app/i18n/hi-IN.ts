const messages = {
  ...
  agentPanel: {
    ...
    keyScope: "कुंजी का दायरा",
    personalKeyScope: "व्यक्तिगत",
    organizationKeyScope: "संगठन",
    personalKeyInEffect: "आपकी व्यक्तिगत कुंजी उपयोग में है।",
    organizationKeyInEffect: "संगठन की कुंजी उपयोग में है।",
  ...
  org: {
    ...
    askAdminTitle: "अपने एडमिन से संपर्क करें",
    askAdminDescription: "इस वर्कस्पेस में शामिल होने के लिए एडमिन से आमंत्रण मांगें।",
    ...
    appRolesOptional: "ऐप भूमिकाएँ",
    noAppRolesFound: "कोई भूमिका नहीं मिली",
    notAssigned: "असाइन नहीं किया गया",
    appPermissions: "ऐप अनुमतियाँ",
    applications: "ऐप्लिकेशन",
    applicationsEmpty: "अभी तक कोई वर्कस्पेस ऐप पंजीकृत नहीं है।",
    applicationsLoadFailed: "वर्कस्पेस ऐप लोड नहीं हो सके।",
    applicationAccess: "{{name}} के लिए एक्सेस",
    applicationAccessAll: "सभी सदस्य",
    applicationAccessRestricted: "सीमित",
    applicationAccessDisabled: "अक्षम",
    ...
    transferTo: "स्वामित्व इसको हस्तांतरित करें",
    cancel: "रद्द करें",
    remove: "हटाएं",
    save: "सहेजें",
    loading: "लोड हो रहा है...",
    ...
    ssoConfirm: {
      title: "क्या इस साइन-इन प्रदाता को आवश्यक बनाएं?",
      description:
        "अगली बार साइन इन करते समय सदस्यों को इस प्रदाता का उपयोग करना होगा। मौजूदा सत्र रद्द किए जा सकते हैं।",
      confirm: "प्रदाता आवश्यक करें",
    },
    ssoSetup: {
      idpSetup: "पहचान प्रदाता सेटअप",
      redirectUri: "रीडायरेक्ट URI",
      spMetadataUrl: "सेवा प्रदाता मेटाडेटा URL",
      dnsRecordName: "DNS TXT रिकॉर्ड नाम",
      dnsRecordValue: "DNS TXT रिकॉर्ड मान",
      dnsPropagation: "सत्यापन से पहले DNS बदलावों के लागू होने की प्रतीक्षा करें।",
    },
    sso: {
      signIn: "संगठन साइन-इन",
      signInHelp: "आवश्यक साइन-इन प्रदाता चुनें।",
      requiredProvider: "आवश्यक साइन-इन प्रदाता",
      optional: "वैकल्पिक",
      google: "Google",
      title: "सिंगल साइन-ऑन",
      description: "OIDC या SAML पहचान प्रदाता कनेक्ट करें।",
      verified: "सत्यापित",
      verifyRequired: "सत्यापन आवश्यक",
      verify: "सत्यापित करें",
      remove: "हटाएं",
      type: "पहचान प्रदाता प्रकार",
      providerId: "प्रदाता आईडी",
      issuer: "इश्यूअर URL",
      domain: "संगठन डोमेन",
      noDomain: "कोई डोमेन कॉन्फ़िगर नहीं",
      clientId: "क्लाइंट आईडी",
      clientSecret: "क्लाइंट सीक्रेट",
      discoveryEndpoint: "डिस्कवरी एंडपॉइंट (वैकल्पिक)",
      entryPoint: "SAML एंट्री पॉइंट URL",
      entityId: "IdP एंटिटी आईडी",
      metadata: "IdP मेटाडेटा XML पेस्ट करें",
      certificate: "साइनिंग प्रमाणपत्र (वैकल्पिक)",
      domainHelp:
        "डोमेन संगठन के सत्यापित डोमेन से मेल खाना चाहिए। सबमिट करने के बाद सीक्रेट और मेटाडेटा फ़ॉर्म से मिटा दिए जाते हैं।",
      saveProvider: "प्रदाता सहेजें",
      cancel: "रद्द करें",
      addProvider: "प्रदाता जोड़ें",
    },
    scim: {
      title: "डायरेक्टरी प्रोविज़निंग",
      description: "इस संगठन के SCIM कनेक्शन प्रबंधित करें।",
      revoke: "रद्द करें",
      copyTokenOnce: "इस टोकन को अभी कॉपी करें। यह फिर नहीं दिखेगा।",
      dismissToken: "टोकन हटाएं",
      createConnection: "SCIM कनेक्शन बनाएं",
    },
