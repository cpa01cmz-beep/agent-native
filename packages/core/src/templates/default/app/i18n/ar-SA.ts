const messages = {
  ...
  agentPanel: {
    ...
    keyScope: "نطاق المفتاح",
    personalKeyScope: "شخصي",
    organizationKeyScope: "المؤسسة",
    personalKeyInEffect: "مفتاحك الشخصي قيد الاستخدام.",
    organizationKeyInEffect: "مفتاح المؤسسة قيد الاستخدام.",
  ...
  org: {
    ...
    askAdminTitle: "تواصل مع المسؤول",
    askAdminDescription: "اطلب من المسؤول دعوتك للانضمام إلى مساحة العمل هذه.",
    ...
    appRolesOptional: "أدوار التطبيق",
    noAppRolesFound: "لم يتم العثور على أدوار",
    notAssigned: "غير معيّن",
    appPermissions: "أذونات التطبيق",
    applications: "التطبيقات",
    applicationsEmpty: "لم يتم تسجيل تطبيقات مساحة العمل بعد.",
    applicationsLoadFailed: "تعذر تحميل تطبيقات مساحة العمل.",
    applicationAccess: "الوصول إلى {{name}}",
    applicationAccessAll: "جميع الأعضاء",
    applicationAccessRestricted: "مقيّد",
    applicationAccessDisabled: "معطّل",
    ...
    ssoConfirm: {
      title: "هل تريد اشتراط موفر تسجيل الدخول هذا؟",
      description:
        "سيحتاج الأعضاء إلى استخدام هذا الموفر في المرة التالية لتسجيل الدخول. قد تُلغى الجلسات الحالية.",
      confirm: "اشتراط الموفر",
    },
    ssoSetup: {
      idpSetup: "إعداد موفر الهوية",
      redirectUri: "URI لإعادة التوجيه",
      spMetadataUrl: "عنوان بيانات تعريف موفر الخدمة",
      dnsRecordName: "اسم سجل DNS TXT",
      dnsRecordValue: "قيمة سجل DNS TXT",
      dnsPropagation: "انتظر انتشار تغييرات DNS قبل التحقق.",
    },
    sso: {
      signIn: "تسجيل دخول المؤسسة",
      signInHelp: "اختر موفر تسجيل الدخول المطلوب.",
      requiredProvider: "موفر تسجيل الدخول المطلوب",
      optional: "اختياري",
      google: "Google",
      title: "تسجيل الدخول الموحد",
      description: "اربط موفر هوية OIDC أو SAML.",
      verified: "تم التحقق",
      verifyRequired: "التحقق مطلوب",
      verify: "تحقق",
      remove: "إزالة",
      type: "نوع موفر الهوية",
      providerId: "معرّف الموفر",
      issuer: "رابط المُصدر",
      domain: "نطاق المؤسسة",
      noDomain: "لم يتم إعداد نطاق",
      clientId: "معرّف العميل",
      clientSecret: "سر العميل",
      discoveryEndpoint: "نقطة الاكتشاف (اختياري)",
      entryPoint: "رابط نقطة دخول SAML",
      entityId: "معرّف كيان موفر الهوية",
      metadata: "الصق بيانات تعريف موفر الهوية XML",
      certificate: "شهادة التوقيع (اختياري)",
      domainHelp:
        "يجب أن يطابق النطاق نطاق المؤسسة الذي تم التحقق منه. تُمسح الأسرار والبيانات الوصفية بعد الإرسال.",
    ...
    scim: {
      title: "توفير الدليل",
      description: "إدارة اتصالات SCIM لهذه المؤسسة.",
      revoke: "إبطال",
      copyTokenOnce: "انسخ هذا الرمز الآن. لن يظهر مرة أخرى.",
      dismissToken: "إخفاء الرمز",
      createConnection: "إنشاء اتصال SCIM",
    },
