const messages = {
  ...
  agentPanel: {
    ...
    keyScope: "Schlüsselbereich",
    personalKeyScope: "Persönlich",
    organizationKeyScope: "Organisation",
    personalKeyInEffect: "Dein persönlicher Schlüssel wird verwendet.",
    organizationKeyInEffect: "Der Organisationsschlüssel wird verwendet.",
  ...
  org: {
    ...
    askAdminTitle: "Bitte Admin kontaktieren",
    askAdminDescription:
      "Bitte einen Administrator um eine Einladung zu diesem Workspace.",
    ...
    appRolesOptional: "App-Rollen",
    noAppRolesFound: "Keine Rollen gefunden",
    notAssigned: "Nicht zugewiesen",
    appPermissions: "App-Berechtigungen",
    applications: "Anwendungen",
    applicationsEmpty: "Noch keine Workspace-Anwendungen registriert.",
    applicationsLoadFailed:
      "Workspace-Anwendungen konnten nicht geladen werden.",
    applicationAccess: "Zugriff für {{name}}",
    applicationAccessAll: "Alle Mitglieder",
    applicationAccessRestricted: "Eingeschränkt",
    applicationAccessDisabled: "Deaktiviert",
    ...
    transferTo: "Eigentum übertragen an",
    cancel: "Abbrechen",
    remove: "Entfernen",
    save: "Speichern",
    loading: "Wird geladen...",
    ...
    ssoConfirm: {
      title: "Diesen Anmeldeanbieter voraussetzen?",
      description:
        "Mitglieder müssen sich beim nächsten Mal über diesen Anbieter anmelden. Aktuelle Sitzungen können widerrufen werden.",
      confirm: "Anbieter voraussetzen",
    },
    ssoSetup: {
      idpSetup: "Einrichtung des Identitätsanbieters",
      redirectUri: "Weiterleitungs-URI",
      spMetadataUrl: "Metadaten-URL des Dienstanbieters",
      dnsRecordName: "DNS-TXT-Eintragsname",
      dnsRecordValue: "DNS-TXT-Eintragswert",
      dnsPropagation:
        "Warten Sie vor der Verifizierung die DNS-Propagation ab.",
    },
    sso: {
      signIn: "Organisationsanmeldung",
      signInHelp: "Wählen Sie den erforderlichen Anmeldeanbieter.",
      requiredProvider: "Erforderlicher Anmeldeanbieter",
      optional: "Optional",
      google: "Google",
      title: "Einmalige Anmeldung",
      description: "Verbinden Sie einen OIDC- oder SAML-Identitätsanbieter.",
      verified: "Verifiziert",
      verifyRequired: "Verifizierung erforderlich",
      verify: "Verifizieren",
      remove: "Entfernen",
      type: "Identitätsanbieter-Typ",
      providerId: "Anbieter-ID",
      issuer: "Aussteller-URL",
      domain: "Organisationsdomain",
      noDomain: "Keine Domain konfiguriert",
      clientId: "Client-ID",
      clientSecret: "Client-Geheimnis",
      discoveryEndpoint: "Discovery-Endpunkt (optional)",
      entryPoint: "SAML-Einstiegs-URL",
      entityId: "IdP-Entitäts-ID",
      metadata: "IdP-Metadaten-XML einfügen",
      certificate: "Signaturzertifikat (optional)",
      domainHelp:
        "Die Domain muss der verifizierten Organisationsdomain entsprechen. Geheimnisse und Metadaten werden nach dem Senden aus dem Formular entfernt.",
      saveProvider: "Anbieter speichern",
      cancel: "Abbrechen",
      addProvider: "Anbieter hinzufügen",
    },
    scim: {
      title: "Verzeichnisbereitstellung",
      description: "SCIM-Verbindungen für diese Organisation verwalten.",
      revoke: "Widerrufen",
      copyTokenOnce:
        "Kopieren Sie dieses Token jetzt. Es wird nicht erneut angezeigt.",
      dismissToken: "Token ausblenden",
      createConnection: "SCIM-Verbindung erstellen",
    },
