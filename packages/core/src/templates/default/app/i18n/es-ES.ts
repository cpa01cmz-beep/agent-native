const messages = {
  ...
  agentPanel: {
    ...
    keyScope: "Ámbito de la clave",
    personalKeyScope: "Personal",
    organizationKeyScope: "Organización",
    personalKeyInEffect: "Se está usando tu clave personal.",
    organizationKeyInEffect: "Se está usando la clave de la organización.",
  ...
  org: {
    ...
    askAdminTitle: "Pide ayuda a tu administrador",
    askAdminDescription:
      "Pide a un administrador que te invite para unirte a este espacio de trabajo.",
    ...
    appRolesOptional: "Roles de la aplicación",
    ...
    ssoConfirm: {
      title: "¿Exigir este proveedor de inicio de sesión?",
      description:
        "Los miembros deberán usar este proveedor la próxima vez que inicien sesión. Es posible que se revoquen las sesiones actuales.",
      confirm: "Exigir proveedor",
    },
    ssoSetup: {
      idpSetup: "Configuración del proveedor de identidad",
      redirectUri: "URI de redireccionamiento",
      spMetadataUrl: "URL de metadatos del proveedor de servicio",
      dnsRecordName: "Nombre del registro DNS TXT",
      dnsRecordValue: "Valor del registro DNS TXT",
      dnsPropagation:
        "Espera a que se propaguen los cambios DNS antes de verificar.",
    },
    sso: {
      signIn: "Inicio de sesión de la organización",
      signInHelp: "Elige el proveedor de inicio de sesión obligatorio.",
      requiredProvider: "Proveedor de inicio requerido",
      optional: "Opcional",
      google: "Google",
      title: "Inicio de sesión único",
      description: "Conecta un proveedor de identidad OIDC o SAML.",
      verified: "Verificado",
      verifyRequired: "Verificación necesaria",
      verify: "Verificar",
      remove: "Eliminar",
      type: "Tipo de proveedor de identidad",
      providerId: "ID del proveedor",
      issuer: "URL del emisor",
      domain: "Dominio de la organización",
      noDomain: "No hay ningún dominio configurado",
      clientId: "ID de cliente",
      clientSecret: "Secreto de cliente",
      discoveryEndpoint: "Punto de descubrimiento (opcional)",
      entryPoint: "URL de entrada SAML",
      entityId: "ID de entidad del IdP",
      metadata: "Pega los metadatos XML del IdP",
      certificate: "Certificado de firma (opcional)",
      domainHelp:
        "El dominio debe coincidir con el dominio verificado de la organización. Los secretos y metadatos se borran del formulario tras enviarlos.",
      saveProvider: "Guardar proveedor",
      cancel: "Cancelar",
      addProvider: "Añadir proveedor",
    },
    scim: {
      title: "Aprovisionamiento de directorio",
      description: "Gestiona las conexiones SCIM de esta organización.",
      revoke: "Revocar",
      copyTokenOnce: "Copia este token ahora. No volverá a mostrarse.",
      dismissToken: "Ocultar token",
      createConnection: "Crear conexión SCIM",
    },
