const messages = {
  ...
  agentPanel: {
    ...
    personalKeyInEffect: "個人のキーを使用しています。",
    organizationKeyInEffect: "組織のキーを使用しています。",
  ...
  org: {
    ...
    askAdminTitle: "管理者にお問い合わせください",
    askAdminDescription:
      "このワークスペースに参加するには、管理者に招待を依頼してください。",
    ...
    appRolesOptional: "アプリのロール",
    noAppRolesFound: "ロールが見つかりません",
    notAssigned: "未割り当て",
    appPermissions: "アプリの権限",
    applications: "アプリケーション",
    applicationsEmpty: "ワークスペースアプリはまだ登録されていません。",
    applicationsLoadFailed: "ワークスペースアプリを読み込めませんでした。",
    applicationAccess: "{{name}} のアクセス",
    applicationAccessAll: "すべてのメンバー",
    applicationAccessRestricted: "制限付き",
    applicationAccessDisabled: "無効",
    ...
    dangerZone: "危険区域",
    ssoConfirm: {
      title: "このサインインプロバイダーを必須にしますか？",
      description:
        "メンバーは次回のサインイン時にこのプロバイダーを使用する必要があります。現在のセッションが取り消される場合があります。",
      confirm: "プロバイダーを必須にする",
    },
    ssoSetup: {
      idpSetup: "ID プロバイダーの設定",
      redirectUri: "リダイレクト URI",
      spMetadataUrl: "サービスプロバイダーのメタデータ URL",
      dnsRecordName: "DNS TXT レコード名",
      dnsRecordValue: "DNS TXT レコード値",
      dnsPropagation: "確認前に DNS の変更が反映されるまでお待ちください。",
    },
    sso: {
      signIn: "組織のサインイン",
      signInHelp: "メンバーに必須のサインインプロバイダーを選択します。",
      requiredProvider: "必須のサインインプロバイダー",
      optional: "任意",
      google: "Google",
      title: "シングルサインオン",
      description: "OIDC または SAML の ID プロバイダーを接続します。",
      verified: "確認済み",
      verifyRequired: "確認が必要",
      verify: "確認",
      remove: "削除",
      type: "ID プロバイダーの種類",
      ...
      discoveryEndpoint: "Discovery エンドポイント（任意）",
      entryPoint: "SAML エントリーポイント URL",
      entityId: "IdP エンティティ ID",
      metadata: "IdP メタデータ XML を貼り付け",
      certificate: "署名証明書（任意）",
      domainHelp:
        "ドメインは組織の確認済みドメインと一致する必要があります。送信後、シークレットとメタデータはフォームから消去されます。",
      saveProvider: "プロバイダーを保存",
      cancel: "キャンセル",
      addProvider: "プロバイダーを追加",
    },
    scim: {
      title: "ディレクトリプロビジョニング",
      description: "この組織の SCIM 接続を管理します。",
      revoke: "取り消す",
      copyTokenOnce:
        "このトークンを今すぐコピーしてください。再表示されません。",
      dismissToken: "トークンを閉じる",
      createConnection: "SCIM 接続を作成",
    },
    deleteOrg: "組織を削除",
