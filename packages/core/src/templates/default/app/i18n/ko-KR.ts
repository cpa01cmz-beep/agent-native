const messages = {
  ...
  agentPanel: {
    ...
    keyScope: "키 범위",
    personalKeyScope: "개인",
    organizationKeyScope: "조직",
    personalKeyInEffect: "개인 키를 사용 중입니다.",
    organizationKeyInEffect: "조직 키를 사용 중입니다.",
  ...
  org: {
    ...
    askAdminTitle: "관리자에게 문의하세요",
    askAdminDescription:
      "이 워크스페이스에 참여하려면 관리자에게 초대를 요청하세요.",
    ...
    appRolesOptional: "앱 역할",
    noAppRolesFound: "역할을 찾을 수 없습니다",
    notAssigned: "할당되지 않음",
    appPermissions: "앱 권한",
    applications: "애플리케이션",
    applicationsEmpty: "아직 등록된 워크스페이스 애플리케이션이 없습니다.",
    applicationsLoadFailed: "워크스페이스 애플리케이션을 불러오지 못했습니다.",
    applicationAccess: "{{name}} 액세스",
    applicationAccessAll: "모든 멤버",
    applicationAccessRestricted: "제한됨",
    applicationAccessDisabled: "사용 중지됨",
    ...
    dangerZone: "위험 구역",
    ssoConfirm: {
      title: "이 로그인 제공자를 필수로 설정할까요?",
      description:
        "구성원은 다음 로그인부터 이 제공자를 사용해야 합니다. 현재 세션이 취소될 수 있습니다.",
      confirm: "제공자 필수 설정",
    },
    ssoSetup: {
      idpSetup: "ID 제공자 설정",
      redirectUri: "리디렉션 URI",
      spMetadataUrl: "서비스 제공자 메타데이터 URL",
      dnsRecordName: "DNS TXT 레코드 이름",
      dnsRecordValue: "DNS TXT 레코드 값",
      dnsPropagation: "확인 전에 DNS 변경 사항이 전파될 때까지 기다리세요.",
    },
    sso: {
      signIn: "조직 로그인",
      signInHelp: "필수 로그인 제공자를 선택하세요.",
      requiredProvider: "필수 로그인 제공자",
      optional: "선택 사항",
      google: "Google",
      title: "싱글 사인온",
      description: "OIDC 또는 SAML ID 제공자를 연결합니다.",
      verified: "확인됨",
      verifyRequired: "확인 필요",
      verify: "확인",
      remove: "삭제",
      type: "ID 제공자 유형",
      providerId: "제공자 ID",
      ...
      discoveryEndpoint: "검색 엔드포인트(선택 사항)",
      entryPoint: "SAML 진입점 URL",
      entityId: "IdP 엔터티 ID",
      metadata: "IdP 메타데이터 XML 붙여넣기",
      certificate: "서명 인증서(선택 사항)",
      domainHelp:
        "도메인은 조직의 확인된 도메인과 일치해야 합니다. 제출 후 비밀과 메타데이터는 양식에서 지워집니다.",
      saveProvider: "제공자 저장",
      cancel: "취소",
      addProvider: "제공자 추가",
    },
    scim: {
      title: "디렉터리 프로비저닝",
      description: "이 조직의 SCIM 연결을 관리합니다.",
      revoke: "해지",
      copyTokenOnce: "이 토큰을 지금 복사하세요. 다시 표시되지 않습니다.",
      dismissToken: "토큰 닫기",
      createConnection: "SCIM 연결 만들기",
    },
    deleteOrg: "조직 삭제",
