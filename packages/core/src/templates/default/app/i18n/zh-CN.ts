const messages = {
  ...
  agentPanel: {
    ...
    keyScope: "密钥范围",
    personalKeyScope: "个人",
    organizationKeyScope: "组织",
    personalKeyInEffect: "当前使用的是您的个人密钥。",
    organizationKeyInEffect: "当前使用的是组织密钥。",
  ...
  org: {
    ...
    askAdminTitle: "请联系管理员",
    askAdminDescription: "请联系管理员获取邀请，以加入此工作区。",
    ...
    members: "Members",
    inviteMembers: "邀请成员",
    appRolesOptional: "应用角色",
    noAppRolesFound: "未找到角色",
    notAssigned: "未分配",
    appPermissions: "应用权限",
    applications: "应用",
    applicationsEmpty: "尚未注册工作区应用。",
    applicationsLoadFailed: "无法加载工作区应用。",
    applicationAccess: "{{name}} 的访问权限",
    applicationAccessAll: "所有成员",
    applicationAccessRestricted: "受限",
    applicationAccessDisabled: "已禁用",
    ...
    ssoConfirm: {
      title: "要求使用此登录提供方？",
      description: "成员下次登录时需要使用此提供方。当前会话可能会被撤销。",
      confirm: "要求使用提供方",
    },
    ssoSetup: {
      idpSetup: "身份提供方设置",
      redirectUri: "重定向 URI",
      spMetadataUrl: "服务提供方元数据 URL",
      dnsRecordName: "DNS TXT 记录名称",
      dnsRecordValue: "DNS TXT 记录值",
      dnsPropagation: "请等待 DNS 更改传播后再验证。",
    },
    sso: {
      signIn: "组织登录",
      signInHelp: "选择成员必须使用的登录提供方。",
      requiredProvider: "必需的登录提供方",
      optional: "可选",
      google: "Google",
      title: "单点登录",
      description: "连接 OIDC 或 SAML 身份提供方。",
      verified: "已验证",
      verifyRequired: "需要验证",
      verify: "验证",
      remove: "移除",
      ...
      clientId: "客户端 ID",
      clientSecret: "客户端密钥",
      discoveryEndpoint: "发现端点（可选）",
      entryPoint: "SAML 入口 URL",
      entityId: "IdP 实体 ID",
      metadata: "粘贴 IdP 元数据 XML",
      certificate: "签名证书（可选）",
      domainHelp:
        "域名必须与组织已验证的域名一致。提交后，密钥和元数据会从此表单中清除。",
      saveProvider: "保存提供方",
      cancel: "取消",
      addProvider: "添加提供方",
    },
    scim: {
      title: "目录配置",
      description: "管理此组织的 SCIM 连接。",
      revoke: "撤销",
      copyTokenOnce: "请立即复制此令牌。它不会再次显示。",
      dismissToken: "关闭令牌",
      createConnection: "创建 SCIM 连接",
    },
    deleteOrg: "删除组织",
