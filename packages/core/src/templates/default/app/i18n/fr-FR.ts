const messages = {
  ...
  agentPanel: {
    ...
    keyScope: "Portée de la clé",
    personalKeyScope: "Personnelle",
    organizationKeyScope: "Organisation",
    personalKeyInEffect: "Votre clé personnelle est utilisée.",
    organizationKeyInEffect: "La clé de l’organisation est utilisée.",
  ...
  org: {
    ...
    askAdminTitle: "Contactez votre administrateur",
    askAdminDescription:
      "Demandez à un administrateur de vous inviter à rejoindre cet espace de travail.",
    ...
    appRolesOptional: "Rôles de l’application",
    noAppRolesFound: "Aucun rôle trouvé",
    notAssigned: "Non attribué",
    appPermissions: "Autorisations de l’application",
    applications: "Applications",
    applicationsEmpty:
      "Aucune application d’espace de travail n’est encore enregistrée.",
    applicationsLoadFailed:
      "Impossible de charger les applications de l’espace de travail.",
    applicationAccess: "Accès pour {{name}}",
    applicationAccessAll: "Tous les membres",
    applicationAccessRestricted: "Restreint",
    applicationAccessDisabled: "Désactivé",
    ...
    transferTo: "Transférer la propriété à",
    cancel: "Annuler",
    remove: "Retirer",
    save: "Enregistrer",
    loading: "Chargement...",
    ...
    ssoConfirm: {
      title: "Exiger ce fournisseur de connexion ?",
      description:
        "Les membres devront utiliser ce fournisseur lors de leur prochaine connexion. Les sessions actuelles peuvent être révoquées.",
      confirm: "Exiger le fournisseur",
    },
    ssoSetup: {
      idpSetup: "Configuration du fournisseur d’identité",
      redirectUri: "URI de redirection",
      spMetadataUrl: "URL des métadonnées du fournisseur de services",
      dnsRecordName: "Nom de l’enregistrement DNS TXT",
      dnsRecordValue: "Valeur de l’enregistrement DNS TXT",
      dnsPropagation: "Attendez la propagation DNS avant de vérifier.",
    },
    sso: {
      signIn: "Connexion de l’organisation",
      signInHelp: "Choisissez le fournisseur de connexion requis.",
      requiredProvider: "Fournisseur de connexion requis",
      optional: "Facultatif",
      google: "Google",
      title: "Authentification unique",
      description: "Connectez un fournisseur d’identité OIDC ou SAML.",
      verified: "Vérifié",
      verifyRequired: "Vérification requise",
      verify: "Vérifier",
      remove: "Supprimer",
      type: "Type de fournisseur d’identité",
      ...
      discoveryEndpoint: "Point de découverte (facultatif)",
      entryPoint: "URL du point d’entrée SAML",
      entityId: "ID d’entité du fournisseur",
      metadata: "Collez les métadonnées XML du fournisseur",
      certificate: "Certificat de signature (facultatif)",
      domainHelp:
        "Le domaine doit correspondre au domaine vérifié de l’organisation. Les secrets et métadonnées sont effacés du formulaire après l’envoi.",
      saveProvider: "Enregistrer le fournisseur",
      cancel: "Annuler",
      addProvider: "Ajouter un fournisseur",
    },
    scim: {
      title: "Provisionnement d’annuaire",
      description: "Gérez les connexions SCIM de cette organisation.",
      revoke: "Révoquer",
      copyTokenOnce: "Copiez ce jeton maintenant. Il ne sera plus affiché.",
      dismissToken: "Masquer le jeton",
      createConnection: "Créer une connexion SCIM",
    },
