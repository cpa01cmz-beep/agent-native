...
To run your own copy: `npx --yes @agent-native/core@latest create my-assets --standalone --template assets`. See [Getting started](/docs/getting-started) for the rest of the local setup.
