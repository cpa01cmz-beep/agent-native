...
<DataModel
  id="doc-block-auditlog1"
  title="agent_audit_log"
  summary="One append-only row per mutating action call. 'caller' is the actual column name for what the prose above calls the surface."
  entities={[
    {
      id: "auditLog",
      name: "agent_audit_log",
      note: "Append-only — no update or delete action exists for these rows.",
      fields: [
        ...
        { name: "created_at", type: "integer", nullable: false },
        {
          ...
          type: "text",
          nullable: false,
          note: "The action name, e.g. delete-recording.",
        },
        {
          name: "caller",
          type: "enum",
          nullable: false,
          note: "tool | frontend | http | cli | mcp | a2a — the surface that invoked the action.",
        },
        {
          name: "actor_kind",
          type: "enum",
          nullable: false,
          note: "agent | human | system",
        },
        ...
        { name: "org_id", type: "text", nullable: true },
        {
          ...
          type: "text",
          nullable: true,
          note: "Agent conversation thread, when caller is the agent loop.",
        },
        { name: "turn_id", type: "text", nullable: true },
        {
          ...
          type: "text",
          nullable: true,
          note: "Set via audit.target on the action.",
        },
        { name: "target_id", type: "text", nullable: true },
        {
          ...
          type: "enum",
          nullable: false,
          note: "success | error | denied — default 'success'.",
        },
        { name: "summary", type: "text", nullable: true },
        {
          ...
          type: "text",
          nullable: true,
          note: "Redacted call arguments, JSON-encoded.",
        },
        { name: "error_code", type: "text", nullable: true },
        {
          ...
          type: "text",
          nullable: true,
          note: "Scopes who can read this event.",
        },
        {
          name: "visibility",
          type: "enum",
          nullable: false,
          note: "private | org | public — default 'private'.",
        },
      ],
    },
  ]}
...
- [**Actions**](/docs/actions-overview) — the `defineAction` seam where capture happens
- [**Human-in-the-Loop Approvals**](/docs/actions-access-control#needs-approval) — gated actions, recorded as `denied`
...
- [**Toolkit piece: History Kit**](/docs/toolkit-history) — the version-history timeline and undo/redo UI built on this trail
