...
1. Scaffold the first workflow with `npx --yes @agent-native/core@latest create my-agent --headless`.
...
- [**Actions**](/docs/actions-overview) — the operations your automation calls
