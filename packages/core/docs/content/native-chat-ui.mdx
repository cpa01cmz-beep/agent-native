...
**Developer page.** This page is for developers building action-declared chat widgets. For the end-user experience of chat, see [Using Your Agent](/docs/using-your-agent).

</Callout>

When you ask for a chart, a table, or a compact report, you get a real interactive widget instead of a wall of text or a screenshot — here's how that's built.
...
- [Actions](/docs/actions-overview) — define the operations that return native widget data.
