...
<Callout id="doc-block-dres1who" tone="info">
...
<div class="diagram-durable">
  ...
  <div class="diagram-col">
    ...
    <div class="diagram-pill accent">
      Layer 2 · hard-block re-dispatched write
    </div>
  </div>
</div>
```
...
- [**Actions**](/docs/actions-overview) — `readOnly` marks reads as safe to re-run; everything else is treated as side-effecting.
- [**In-Loop Processors**](/docs/processors) — another loop-internal hardening seam.
- [**Durable Background Runs**](/docs/durable-background-runs) — moving a long turn onto a separate background function.
