...
الأصول عبارة عن مساحة عمل أصلية للوكيل لإنشاء الوسائط المتوافقة مع العلامة التجارية وإدارتها، خاصة عندما تتمتع نماذج الصور أو الفيديو بميزة واضحة. ينظم التحميلات والنتائج التي تم إنشاؤها في المكتبات والمجلدات، ويتيح للفرق جمع مراجع معتمدة للقطات المنتجات والشعارات والصور الاجتماعية والمشاهد الواقعية وغيرها من الوسائط لاستخدامها في تكوين Design أو في مكان آخر، ثم يوجه عملية الإنشاء عبر دردشة الوكيل حتى يمكن مراجعة كل أصل وتحسينه.

<WireframeBlock id="doc-block-1iutams">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1dgpq40" title={"إنشاء ومراجعة وإعادة الاستخدام"} summary={"المراجع والمطالبات تغذي جلسة إنشاء واختيار؛ تصل الأصول المختارة إلى مكتبة وتتدفق إلى تطبيقات أخرى عبر المنتقي أو A2A."}>
...
<div class="diagram-assets">
  <div class="diagram-col">
    <div class="diagram-node">
      References<br /><small class="diagram-muted"
        >الشعارات، صور المنتج، الأسلوب</small
      >
    </div>
    <div class="diagram-node">
      اِسْتَدْعَى<br /><small class="diagram-muted"
        >الدردشة أو عناصر تحكم Generate</small
      >
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    <span class="diagram-pill accent">جلسة إنشاء</span
  ...
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    <span class="diagram-pill ok">مكتبة</span
    ><small class="diagram-muted">assets مختارة ومتسقة مع العلامة</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-node">
      Picker<br /><small class="diagram-muted">iframe / تطبيق MCP</small>
    </div>
    <div class="diagram-node">
      A2A<br /><small class="diagram-muted">شرائح · تصميم · محتوى</small>
    </div>
  </div>
</div>
```
...
## الأصول مقابل التصميم

استخدم **Design** لمعظم الأعمال المرئية. ابدأ به للصفحات المقصودة والإعلانات والرسوم البيانية والتكوينات الأخرى عندما تحتاج إلى HTML/CSS أو تخطيط دقيق أو بنية قابلة للتحرير أو الاستيراد والتصدير من أدوات التصميم.

استخدم **Assets** عندما تكون نماذج الصور أو الفيديو أنسب للمهمة ويمكن استخدام النتيجة كوسائط بدلًا من تحريرها جزءًا جزءًا. يشمل ذلك الصور الواقعية أو المعتمدة على البكسل ولقطات المنتجات والصور الاجتماعية والفيديو. وقد تكون الرسوم البيانية المرسومة يدويًا أو بأسلوب Excalidraw استثناءً عندما تريد الصورة المولدة كما هي.

سير العمل المقصود هو البدء في Design وترك وكيل Design يفوض إنشاء الصور الداعمة إلى Assets عندما تكون PNG أو أي وسائط أخرى هي الاختيار المناسب. استخدم النتيجة في تكوين Design أو في تطبيق آخر.
  ...
  entities={[
    {
      ...
      note: "حاوية ذات مستوى أعلى قابلة للامتلاك",
      fields: [
        {
          name: "id",
          type: "id",
