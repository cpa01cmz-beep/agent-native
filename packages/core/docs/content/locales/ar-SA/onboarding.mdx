...
<Diagram id="doc-block-f2r0l0" title={"قائمة التحقق من الإعداد"} summary={"مطلوب فقط توصيل محرك AI. تقوم اللوحة بتتبع الإكمال والإخفاء التلقائي بمجرد الانتهاء من كل ما هو مطلوب."}>

```html
<div class="ob">
  <div class="diagram-card">
    <span class="diagram-pill warn">required</span><strong>وصل محرك AI</strong
  ...
  <div class="diagram-card">
    <span class="diagram-pill">optional</span
    ><strong>تسليم البريد الإلكتروني</strong
...
<Endpoint id="doc-block-1n92aj8" title={"قم بإدراج خطوات الإعداد"} method="GET" path="/_agent-native/onboarding/steps" summary={"قم بإدراج جميع الخطوات المسجلة مع حالة اكتمالها"} responses={[
  {
    "status": "200",
...
<AnnotatedCode
  ...
  annotations={[
    {
      lines: "5",
      label: "مثبتة تلقائيًا",
      note: "قم بالتسجيل من مكون إضافي Nitro - يعالج إطار العمل العرض وتتبع الإكمال والفصل.",
    },
    {
      lines: "7",
      label: "معرف المكدس",
      note: "إعادة التسجيل بنفس `id` بعد تحميل الإعدادات الافتراضية يتجاوز خطوة مضمنة.",
    },
    {
      lines: "12-19",
      label: "الطريقة الأساسية",
      note: '`primary: true` marks the big CTA. `kind: "link"` sends the user into the OAuth flow.',
    },
    {
      lines: "20-26",
      label: "مسار التفويض",
      note: '`kind: "agent-task"` يسلّم الإعداد إلى دردشة الوكيل مع مطالبة.',
    },
    {
      lines: "28-31",
      label: "التحقق من الإكمال",
      note: "`isComplete` يعمل من جانب الخادم. رموز OAuth موجودة في متجر `oauth_tokens` - تحقق منها، وليس `process.env.GMAIL_REFRESH_TOKEN`.",
    },
  ]}
/>
...
| `database` | لا    | عنوان PostgreSQL مستضاف أو اتركه فارغًا لاستخدام PGlite المحلي |
