...
- **العارض** — للقراءة فقط.
- **المعلّق** — للقراءة وإضافة التعليقات، ولكن لا يمكنه تعديل المورد أو إدارة المشاركات.
- **المحرر** — قراءة + كتابة.
...
- **تطبيقات البيانات الشخصية** (البريد) — على نطاق المستخدم حسب التصميم. لا يوجد مفهوم "مشاركة البريد الوارد".
