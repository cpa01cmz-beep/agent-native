...
يتعامل إطار العمل مع كل هذا تلقائيًا. يحصل المستخدمون المتصلون بـ Builder (free tier available) على Gemini Flash-Lite المستضاف على Builder افتراضيًا؛ وإلا يمكن للمستخدمين إحضار مفتاح الموفر الخاص بهم أو العودة إلى التعرف على الكلام في المتصفح.
...
1. **Builder Gemini Flash-Lite (افتراضي عند اتصال Builder).** يقوم المتصفح بنشر الصوت إلى `/_agent-native/transcribe-voice`، الذي يقوم بالتوصيل من خلال Builder.io (free tier available) باستخدام Gemini Flash-Lite. لا يلزم وجود مفتاح Google API.
...
<div class="diagram-voice">
  ...
  <div class="diagram-card col">
    ...
    <small class="diagram-muted">الافتراضي عند اتصال Builder</small>
...
Builder هو المسار الأسهل: قم بتوصيل Builder.io (free tier available) من الإعدادات وسيصبح الموفر الافتراضي Builder Gemini Flash-Lite. بالنسبة لموفري BYOK، أضف المفتاح المطابق في الإعدادات → مفاتيح API.
