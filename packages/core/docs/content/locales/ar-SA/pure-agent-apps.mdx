...
- [**Actions**](/docs/actions-overview) — الأدوات التي سيتصل بها وكيلك النقي

لإنشاء تطبيق بلا رأس جديد، استخدم `npx --yes @agent-native/core@latest create my-agent --headless`.
