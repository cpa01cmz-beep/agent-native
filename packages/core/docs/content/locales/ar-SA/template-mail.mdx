...
<WireframeBlock id="doc-block-1urfn7t">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1l5dwfu" title={"كيف يتدفق طلب البريد"} summary={"تعمل اختصارات لوحة المفاتيح ومطالبات الوكيل على تشغيل نفس الإجراءات. البريد الإلكتروني موجود في Gmail؛ المسودات والأتمتة والتتبع مباشرة في SQL وapplication_state."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      أنت تقود<br /><small class="diagram-muted">J/K/E/R اختصارات</small>
    </div>
    <div class="diagram-node">
      أنت تسأل الوكيل<br /><small class="diagram-muted"
        >"صياغة تراجع ودي"</small
      >
    </div>
  </div>
  ...
  <div class="diagram-col">
    <div class="diagram-box">
      Gmail<br /><small class="diagram-muted">حسابات متعددة، عبر OAuth</small>
    </div>
    <div class="diagram-box">
      SQL + application_state<br /><small class="diagram-muted"
        >مسودات · أتمتة · تتبع</small
      >
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&#8635;</div>
  <div class="diagram-box">يتم تحديث البريد الوارد مباشرة</div>
</div>
```
...
<DataModel
  id="doc-block-1izkaft"
  title={"جداول البريد SQL"}
  summary={
    "البريد الإلكتروني نفسه موجود في Gmail. تحتوي جداول SQL على ما لا يحتوي عليه Gmail: المسودات الموضوعة في قائمة الانتظار، وأحداث تتبع الإرسال، والرموز المميزة OAuth. الإعدادات والحالة المؤقتة موجودة في الإعدادات ومتاجر application_state."
  }
  entities={[
    {
...
أجرِ هذه التغييرات في مستودعك ومسار التطوير الخاص بك. يمكن للوكيل المضمّن المساعدة في تحرير المصدر فقط عندما يمنحه المضيف عمدًا أدوات كتابة repository/workspace؛ وبخلاف ذلك يعمل من خلال actions والبيانات. راجع [Key Concepts](/docs/key-concepts#agent-modifies-code).
...
- [**الإجراءات**](/docs/actions-overview) — نظام الإجراءات الذي تستدعيه المحادثة والاختصارات والأتمتة
