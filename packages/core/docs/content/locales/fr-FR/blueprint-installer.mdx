...
<Diagram id="doc-block-hndzn" title={"ajouter imprime une recette ; votre agent de codage l'applique"} summary={"agent-native émet un plan Markdown vers stdout (diagnostics vers stderr) ; vous le dirigez vers Claude Code ou Codex, qui édite votre dépôt en direct avec un contexte complet."}>
...
<div class="diagram-bp">
  ...
  <div class="diagram-box" data-rough>
    Blueprint Markdown<br /><small class="diagram-muted"
      >stdout · fichiers à toucher · règles · vérifier</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-panel center" data-rough>
    Agent de code<br /><small class="diagram-muted">claude · codex</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
...
agent-native add <kind> <https://docs…>   # rechercher et intégrer à partir d'un URL
...
- [**Actions**](/docs/actions-overview) — la source unique de vérité sur laquelle chaque plan s'appuie
