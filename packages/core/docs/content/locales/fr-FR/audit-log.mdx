...
- [**Actions**](/docs/actions-overview) — la couture `defineAction` où se produit la capture
- [**Human-in-the-Loop Approvals**](/docs/actions-access-control#needs-approval) — actions fermé, enregistré sous le nom `denied`
