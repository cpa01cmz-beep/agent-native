...
<Diagram id="doc-block-1ec0xdy" title={"Trois surfaces créées + une surface d'exécution"} summary={"AGENTS.md et les descriptions d'outils se chargent à chaque tour ; charge de compétences sur demande ; application_state est écrit en direct par votre interface utilisateur."}>

```html
<div class="diagram-surfaces">
  <div class="diagram-card always" data-rough>
    <span class="diagram-pill accent">Chaque tour</span
    ><strong>AGENTS.md</strong
    ><small class="diagram-muted"
      >la carte : objectif, règles clés, clés d’état, index actions +
      compétences</small
    >
  </div>
  <div class="diagram-card always" data-rough>
    <span class="diagram-pill accent">Chaque tour</span
    ><strong>Descriptions d’outils</strong
    ><small class="diagram-muted"
      >guide le choix des outils — une phrase précise chacun</small
    >
  </div>
  <div class="diagram-card ondemand" data-rough>
    <span class="diagram-pill">À la demande</span><strong>Compétences</strong
    ><small class="diagram-muted"
      >guide approfondi, chargé quand la description correspond</small
    >
  </div>
  <div class="diagram-card runtime" data-rough>
    <span class="diagram-pill ok">Live</span><strong>application_state</strong
    ><small class="diagram-muted"
      >écrit par votre UI : navigation, sélection, focus</small
    >
  </div>
</div>
```
...
`AGENTS.md` est la norme universelle sur laquelle s'appuie le framework, si bien que tout outil de codage IA qui lit les instructions de projet fonctionne immédiatement :

- **Claude Code** : lit `CLAUDE.md` (lié par un symlink à `AGENTS.md` par la configuration de la CLI)
- **Cursor** : lit directement `AGENTS.md`, ou `.cursorrules` (l'ancien emplacement de Cursor) s'il est présent
- **Windsurf** : lit directement `AGENTS.md`, ou `.windsurfrules` (l'ancien emplacement de Windsurf) s'il est présent
- **Codex, Gemini et autres** : fonctionnent via le panneau d'agent intégré
