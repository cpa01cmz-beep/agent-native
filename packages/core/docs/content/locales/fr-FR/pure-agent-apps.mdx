...
- [**Actions**](/docs/actions-overview) — les outils que votre agent pur appellera

Pour créer une nouvelle application headless, utilisez `npx --yes @agent-native/core@latest create my-agent --headless`.
