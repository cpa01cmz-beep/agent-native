...
description: "Édition collaborative multi-utilisateurs où l'agent IA est un homologue de premier ordre : fusion CRDT, présence en direct, chemin rapide SSE et fusion granulaire côté serveur, sur PostgreSQL/PGlite et n'importe quel hôte."
---
...
- **Fonctionne partout** – PostgreSQL/PGlite.
...
La table est gérée par le framework et indépendante du fournisseur (utilisation de PGlite et Postgres
...
| ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Postgres sur un hôte accessible publiquement**                                | La passerelle contacte la base de données depuis son propre réseau. PGlite, `localhost`, `*.internal` et les adresses IP nues sont refusés avant même que la chaîne de connexion PostgreSQL ne quitte votre machine. | `DATABASE_URL` pointe vers un Postgres géré tel que Neon                                                                                                                                                        |
...
d'un canal. L'application envoie sa chaîne de connexion PostgreSQL et son origine publique,
...
**L'auto-enregistrement signifie envoyer à Builder la chaîne de connexion PostgreSQL de
...
pas de clé Builder au niveau du déploiement, une connexion PostgreSQL indisponible ou
