...
<Diagram id="doc-block-1m0f26j" title="Deux couches bloquent les effets secondaires en double lors de la reprise" summary={"Le journal lit le grand livre durable et classe les appels antérieurs ; la couche 1 indique au modèle, la couche 2 bloque en dur une écriture redistribuée qui correspond à une entrée terminée."}>
...
<div class="diagram-durable">
  ...
  <div class="diagram-col">
    ...
    <div class="diagram-pill accent">
      Couche 2 · écriture re-dispatchée avec blocage dur
    </div>
  </div>
</div>
```
...
- [**Actions**](/docs/actions-overview) : `readOnly` indique que la lecture est sûre et peut être réexécutée ; tout le reste est traité comme un effet secondaire.
