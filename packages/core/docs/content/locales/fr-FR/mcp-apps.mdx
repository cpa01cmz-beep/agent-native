...
<Diagram id="doc-block-1hyh4ia" title={"MCP Aller-retour intégré à l'application"} summary={"La cible du lien de l'action est également la cible de l'intégration. Les hôtes capables chargent la même route d'application signée en ligne ; tout le monde revient au lien profond."}>
...
<div class="diagram-embed">
  ...
  <div class="diagram-card" data-rough>
    ...
    ><small class="diagram-muted">échange un ticket SQL à usage unique</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card" data-rough>
    <strong>Signed app route</strong
    ><span class="diagram-pill ok">vraie route React</span
    ><small class="diagram-muted">short-lived browser session</small>
  </div>
  <div class="diagram-fallback">
    <span class="diagram-pill warn">pas de prise en charge MCP Apps</span>
...
<AnnotatedCode
  id="doc-block-uc17af"
  title="La configuration des ressources mcpApp"
...
<div class="diagram-bridge">
  <div class="diagram-col">
    <div class="diagram-card" data-rough>
      ...
      ><small class="diagram-muted"
        >hydrate le HTML signé de l’app dans l’iframe de Claude, puis pont hôte
        direct `ui/_`</small
      >
    </div>
    <div class="diagram-card" data-rough>
  ...
  <div class="diagram-box" data-rough>
    Same signed app route<br /><small class="diagram-muted"
      >route normale + composants React</small
    >
  </div>
</div>
```
...
- [Actions](/docs/actions-overview) — `defineAction`, le constructeur `link`, `publicAgent`.
