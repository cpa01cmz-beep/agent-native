...
<Diagram id="doc-block-me2sdy" title="Trois couches sur un seul magasin" summary={"CLI, Desktop et l'interface utilisateur partagée sont des surfaces différentes sur le même magasin d'exécution et le même exécuteur sauvegardés sur des fichiers ; les hôtes l'adaptent via le contrat CodeAgentsHost."}>
...
<div class="diagram-layers">
  <div class="diagram-row">
    <div class="diagram-card" data-rough>
      ...
      ><small class="diagram-muted"
        >démarrer · reprendre · statut · arrêter</small
      >
    </div>
    <div class="diagram-card" data-rough>
      <span class="diagram-pill">Desktop</span
      ><small class="diagram-muted"
        >terminal natif · webviews · liens profonds</small
      >
    </div>
    <div class="diagram-card" data-rough>
      <span class="diagram-pill accent">Partagerd UI</span
  ...
  <div class="diagram-box" data-rough>
    Store d’exécution sur fichiers + exécuteur<br /><small class="diagram-muted"
...
[Harness Agents](/docs/harness-agents) ; cet adaptateur résout désormais sur l'hôte les
identifiants d'abonnement natifs pris en charge sans copier le fichier d'authentification
local dans le bac à sable.
...
```bash
npx --yes @agent-native/core@latest create my-code-ui --template chat
cd my-code-ui
...
<Diagram id="doc-block-1bshm9k" title="Le Dispatch distant est uniquement sortant" summary={"Le mobile ne parle jamais directement au bureau. Desktop interroge longuement Dispatch, revendique les commandes, pilote le magasin d'exécution local et reflète les résultats."}>

```html
<div class="diagram-remote">
  <div class="diagram-node" data-rough>
    Application mobile / Telegram<br /><small class="diagram-muted"
      >/code · séances</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    Relais Dispatch<br /><small class="diagram-muted"
      >hôtes · exécutions · transcription</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&larr;</div>
  <div class="diagram-node" data-rough>
    Desktop<br /><small class="diagram-muted"
      >long-polls · revendique · pilote le store d’exécution</small
    >
  </div>
</div>
```
...
<Endpoint id="doc-block-m4v3ij" title={"Le bureau revendique le travail en file d'attente"} method="POST" path="/_agent-native/integrations/remote/poll" summary={"Le bureau interroge longuement le relais pour réclamer les commandes mises en file d'attente"} auth="Desktop device token" responses={[
  {
    "status": "200",
