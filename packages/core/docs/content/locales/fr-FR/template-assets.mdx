...
Assets est un espace de travail natif pour les agents permettant de créer et de gérer des médias cohérents avec la marque, en particulier lorsque les modèles d'image ou de vidéo offrent un avantage évident. Il organise les téléchargements et les résultats générés dans des bibliothèques et des dossiers, permet aux équipes de collecter des références approuvées de produits, de logos, d'images pour les réseaux sociaux, de scènes photoréalistes et d'autres médias à utiliser dans une composition Design ou ailleurs, puis achemine la génération via le chat de l'agent afin que chaque élément puisse être examiné et affiné.

<WireframeBlock id="doc-block-1119ncv">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-9k2flm" title={"Générer, réviser, réutiliser"} summary={"Les références et les invites alimentent une session de génération et de choix ; Les actifs choisis atterrissent dans une bibliothèque et sont diffusés vers d'autres applications via le sélecteur ou A2A."}>
...
<div class="diagram-assets">
  <div class="diagram-col">
    <div class="diagram-node">
      References<br /><small class="diagram-muted"
        >logos, visuels produit, style</small
      >
    </div>
    <div class="diagram-node">
      Invite<br /><small class="diagram-muted"
        >chat ou commandes Generate</small
      >
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    <span class="diagram-pill accent">Session de génération</span
  ...
  <div class="diagram-box" data-rough>
    ...
    ><small class="diagram-muted"
      >assets choisis et cohérents avec la marque</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-node">
      Picker<br /><small class="diagram-muted">iframe / application MCP</small>
    </div>
    <div class="diagram-node">
      A2A<br /><small class="diagram-muted"
        >Diapositives · Design · Contenu</small
      >
    </div>
  </div>
</div>
...
Utilisez **Design** pour la plupart des travaux visuels. Commencez par là pour les pages de destination, les publicités, les diagrammes et autres compositions lorsque vous avez besoin de HTML/CSS, d'une mise en page précise, d'une structure modifiable ou d'import/export avec un outil de design.

Utilisez **Assets** lorsque les modèles d'image ou de vidéo sont plus adaptés et que le résultat peut être utilisé comme média plutôt que modifié élément par élément. Cela inclut les images photoréalistes ou pixelisées, les photos de produits, les images pour les réseaux sociaux et les vidéos. Les diagrammes dessinés à la main ou dans le style Excalidraw peuvent constituer une exception si vous souhaitez utiliser l'image générée telle quelle.

Le workflow prévu consiste à commencer dans Design et à laisser l'agent Design déléguer la génération d'images d'appoint à Assets lorsqu'un PNG ou un autre média est le meilleur choix. Utilisez ensuite le résultat dans la composition Design ou dans une autre application.
...
<DataModel
  id="doc-block-6r1pfn"
  title={"Modèle de données Assets"}
  summary={
    "Les bibliothèques sont le conteneur possédé ; collections, dossiers et presets les organisent. Les sessions pilotent la génération et le choix ; les assets et les runs conservent la sortie et le journal d’audit. Les noms de table gardent le préfixe historique image_* mais couvrent tous les médias."
  }
  entities={[
    {
      id: "library",
      name: "image_libraries",
      note: "Conteneur propriétaire de premier niveau",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Groupements Style/category",
      fields: [
        {
          name: "library_id",
          type: "id",
    ...
    },
    {
      ...
      note: "Recettes de génération enregistrées",
      fields: [
        {
          name: "media_type",
          type: "text",
    ...
    },
    {
      ...
      note: "Générer et choisir itérativement",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Actifs du candidat dans une session",
      fields: [
        {
          name: "session_id",
          type: "id",
    ...
    },
    {
      ...
      note: "Journal d'audit de génération",
      fields: [
        {
          name: "model",
          type: "text",
