...
<Diagram id="doc-block-1tf829s" title={"公開路由發布什麼"} summary={"一條公開路由呈扇形展開，形成對代理友好的代表。讀取路由與呼叫工具是分開的——工具存取保持選取加入。"}>

```html
<div class="diagram-web">
  <div class="diagram-box" data-rough>
    公開路由<br /><small class="diagram-muted"
  ...
  <div class="diagram-col gate">
    <span class="diagram-pill warn">工具保持私人</span
...
<AnnotatedCode
  ...
  annotations={[
    ...
    },
    {
      lines: "5-7",
      label: "自我描述安全性",
      note: "將其標記為唯讀，聲明它是否需要驗證，並標記它是否是重要的。除非策略明確允許，否則公開 MCP 排除 consequential/write 操作。",
    },
  ]}
/>
...
- [**Actions**](/docs/actions-overview) — 如何選取 actions 加入公開代理協議
