...
- [**Actions**](/docs/actions-overview) — 캡처가 발생하는 `defineAction` 이음새
- [**Human-in-the-Loop Approvals**](/docs/actions-access-control#needs-approval) — 게이트된 actions, `denied`로 기록됨
