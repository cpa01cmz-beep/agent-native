...
- [**Actions**](/docs/actions-overview) - वे tools जिन्हें आपकी automation-first app call करेगी

नई headless app बनाने के लिए `npx --yes @agent-native/core@latest create my-agent --headless` चलाएँ।
