...
<Diagram id="doc-block-e6xdom" title={"स्रोत से उद्धृत उत्तर तक"} summary={"मस्तिष्क अनुमोदित स्रोतों को कच्चे कैप्चर में समाहित करता है, टिकाऊ मेमोरी को डिस्टिल करता है, समीक्षा के माध्यम से इसे गेट करता है, और उसके बाद ही उद्धरणों के साथ उत्तर देता है।"}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-box" data-rough>
    कच्चे कैप्चर<br /><small class="diagram-muted"
      >डुप्लिकेट हटाया, संपादित</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    Distill<br /><small class="diagram-muted"
      >तथ्य · निर्णय · प्रक्रियाएं</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card">
  ...
  <div class="diagram-box" data-rough>
    ...
    ><small class="diagram-muted">स्वीकृत, परमाणु</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
...
<WireframeBlock id="doc-block-uslzh2">
  <Screen
    surface="desktop"
    html={
...
कोई वेक्टर-डेटाबेस आवश्यकता नहीं है, इसलिए टेम्पलेट PGlite में पोर्टेबल रहता है,
Postgres, नियॉन, Postgres, hosted PostgreSQL, और समान होस्ट। एप्लिकेशन स्थिति
वर्तमान मार्ग, फ़िल्टर और चयनित आईडी ताकि एजेंट को हमेशा वर्तमान का पता रहे
नेविगेशन और चयन।

मस्तिष्क की स्कीमा `templates/brain/server/db/schema.ts` में रहती है। नौ टेबल:
...
<Endpoint id="doc-block-fzfwb1" title={"हस्ताक्षरित इनजेस्ट वेबहुक"} summary={"क्लिप और सामान्य transcript/capture आयात प्रति-स्रोत वाहक टोकन के साथ एक रॉकैप्चरपेलोड पोस्ट करते हैं।"} method="POST" path="/api/_agent-native/brain/ingest" summary={"क्लिप्स या सामान्य स्रोत से एक कच्चा कैप्चर आयात करें"} auth={"Bearer <ingestToken> issued per source via its sourceKey"} request={{
...
ये बदलाव repository development workflow में करें। Embedded agent source edits
में केवल तभी मदद कर सकता है जब host जानबूझकर repository/workspace write tooling
दे; अन्यथा वह actions और data के माध्यम से काम करता है। देखें
...
- [**एजेंट संसाधन**](/docs/agent-resources) - सभी ऐप्स में साझा संसाधन
- [**A2A Protocol**](/docs/a2a-protocol) - क्रॉस-ऐप डेलिगेशन
- [**टेम्पलेट**](/docs/cloneable-saas) — क्लोन-एंड-ओन मॉडल और शुरुआत के लिए हर अन्य डोमेन टेम्पलेट
- [**शुरू करना**](/docs/getting-started) — फ़्रेमवर्क की मूल बातें: actions, application state और live sync
