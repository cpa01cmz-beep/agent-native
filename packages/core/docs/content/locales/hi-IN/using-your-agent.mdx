...
Agent-Native के पीछे परिभाषित विचार यह है कि agent और UI **समान भागीदार** हैं - कारण के लिए [Agent-Native क्या है?](/docs/what-is-agent-native) देखें। यह अनुभाग उस वादे के दूसरे भाग के बारे में है: आपके ऐप के बगल में dock होने के बाद agent के साथ वास्तव में काम करना कैसा लगता है।
...
<Diagram id="doc-block-1rbe87n" title={"दिन-प्रतिदिन का चक्र"} summary={"डॉक किए गए एजेंट के साथ काम करने के पांच तरीके - प्रत्येक इस अनुभाग में एक पृष्ठ है।"}>
...
<div class="diagram-loop">
  ...
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card">
    <strong>हल्की UI</strong
    ><small class="diagram-muted">chat is the product</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card accent-card">
    <span class="diagram-pill accent">सह-संपादन</span
    ><small class="diagram-muted">लाइव, साथ-साथ</small>
  </div>
</div>
```
