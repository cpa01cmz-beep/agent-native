...
- **उप-एजेंट** - अपने स्वयं के थ्रेड, अपने स्वयं के सिस्टम प्रॉम्प्ट, अपने स्वयं के टूल सेट के साथ चलते हैं। प्रत्येक [एजेंट संसाधन](/docs/agent-resources) में एक "कस्टम एजेंट" प्रोफ़ाइल पर मैप होता है।
...
<Diagram id="doc-block-1uldv82" title={"ऑर्केस्ट्रेटर और विशेषज्ञ"} summary={"मुख्य चैट उप-एजेंटों को सौंपती है जो अपने स्वयं के थ्रेड में चलते हैं और इनलाइन चिप्स के रूप में वापस रिपोर्ट करते हैं।"}>

```html
<div class="at-orc">
  <div class="diagram-card main">
    <span class="diagram-pill accent">मुख्य चैट</span
  ...
  <div class="at-fan">
    ...
    <div class="at-subs">
      <div class="diagram-box">
        कोड समीक्षा<br /><small class="diagram-muted"
          >own thread &amp; prompt</small
        >
      </div>
      <div class="diagram-box">
        BigQuery विश्लेषण<br /><small class="diagram-muted">own tools</small>
      </div>
      <div class="diagram-box">
        आवाज में ईमेल<br /><small class="diagram-muted">own context</small>
      </div>
    </div>
  </div>
...
कस्टम एजेंट `agents/<slug>.md` के कार्यस्थल में रहते हैं - YAML फ्रंटमैटर के साथ एक Markdown फ़ाइल। प्रारूप के लिए [Custom Agents](/docs/agent-resources#custom-agents) देखें।
...
<Diagram id="doc-block-12eaqrp" title={"स्पॉनटास्क() क्या करता है"} summary={"प्रत्येक स्पॉन एक थ्रेड बनाता है, स्थिति को SQL तक बनाए रखता है, और चिप इवेंट को पूरा होने तक स्ट्रीम करता है।"}>
...
<Diagram id="doc-block-gut3mf" title={"डेलिगेशन डेप्थ गार्ड (डिफ़ॉल्ट कैप 2)"} summary={"प्रत्येक स्तर टोपी तक एक गहरा पैदा कर सकता है; इसके बाद एक स्पॉन को सर्वर-साइड द्वारा अस्वीकार कर दिया जाता है।"}>

```html
<div class="at-depth">
  <div class="diagram-card ok">
    <span class="diagram-pill">depth 0</span><strong>टॉप-लेवल चैट</strong
    ><small class="diagram-muted ok">may spawn &darr;</small>
  </div>
  <div class="diagram-card ok">
    <span class="diagram-pill">depth 1</span><strong>उप-एजेंट</strong
    ><small class="diagram-muted ok">may spawn &darr;</small>
  </div>
  <div class="diagram-card warn">
    <span class="diagram-pill warn">depth 2</span
    ><strong>उप-एजेंट's sub-agent</strong
...
- [**एजेंट संसाधन — Custom Agents**](/docs/agent-resources#custom-agents) - प्रोफ़ाइल प्रारूप
- [**A2A Protocol**](/docs/a2a-protocol) - जब "उप-एजेंट" पूरी तरह से एक अलग ऐप में रहता है
- [**Actions**](/docs/actions-overview) - वे उपकरण जिन्हें उप-एजेंट कॉल करता है
