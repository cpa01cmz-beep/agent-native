...
> **कौन सा कार्यक्षेत्र दस्तावेज़?** यह पृष्ठ **शासन** को कवर करता है - एक रेपो में कई ऐप्स की समीक्षा, अनुमोदन और स्वामित्व कौन करता है। एजेंट अनुकूलन परत (एजेंट संसाधन: `AGENTS.md`, मेमोरी, skills, कस्टम एजेंट) के लिए [Agent Resources](/docs/agent-resources) देखें; परिनियोजन आकार (एक मोनोरेपो, कई ऐप्स) के लिए [Multi-App Workspaces](/docs/multi-app-workspace) देखें।
...
<Diagram id="doc-block-1xlc9n" title={"दो शासन विमान"} summary={"Git कोड को नियंत्रित करता है; Dispatch रनटाइम को नियंत्रित करता है। वे पूरक हैं - एक को दूसरे के अंदर दोहराएँ नहीं।"}>

```html
<div class="gov">
  <div class="diagram-card">
    <span class="diagram-pill accent">Git और GitHub</span
    ><strong>कोड गवर्नेंस</strong>
    <div class="gov-list">
      <span class="diagram-pill">CODEOWNERS</span
      ><span class="diagram-pill">branch protection</span
      ><span class="diagram-pill">PR समीक्षा</span
...
हर कोई जिसे परिवर्तन करने की आवश्यकता है, वह गिट के साथ सहज नहीं है। [Builder.io](https://www.builder.io?utm_source=agent-native&utm_medium=docs&utm_campaign=framework&utm_content=workspace_management) एक विज़ुअल ब्रांचिंग मॉडल का समर्थन करता है जो हुड के नीचे गिट शाखाओं को मैप करता है - सामग्री और प्रतिलिपि परिवर्तन, लेआउट समायोजन, डिज़ाइन पुनरावृत्तियों और बिना किसी देव वातावरण के ए/बी परीक्षण के लिए उपयोगी।
...
<FileTree
  id="doc-block-1e5pgfh"
  title={"repo में governance config"}
  entries={[
    {
      path: ".github/CODEOWNERS",
      note: "बदले गए path के अनुसार reviewers auto-assign करता है",
    },
    {
      path: ".github/labeler.yml",
      note: "app के अनुसार PRs पर labels auto-apply करता है",
    },
    {
    ...
    {
      path: "package.json",
      note: "Workspace-level: platform team ownership",
    },
  ]}
/>
...
| **स्कीमा माइग्रेशन**             | प्लेटफ़ॉर्म टीम + वरिष्ठ इंजीनियर    | डेटा सुरक्षा, PostgreSQL संगतता                                             |
...
संसाधन मॉडल और विहित पथों के लिए, [Agent Resources — Global resources](/docs/agent-resources#global-resources) देखें।

## सेटअप चेकलिस्ट

एक नए कार्यक्षेत्र के लिए, `npx --yes @agent-native/core@latest create` चलाने के बाद:
...
- [ ] फिर साझा प्रदाता खातों के लिए पुन: प्रयोज्य कार्यक्षेत्र कनेक्शन पंजीकृत करें
      ...
      वह खाता
- [ ] संसाधन पृष्ठ के माध्यम से कार्यक्षेत्र-व्यापी skills, रेलिंग निर्देश और ब्रांड/कंपनी संदर्भ संसाधन जोड़ें। संपूर्ण संसाधन-मॉडल तालिका और अनुशंसित स्टार्टर पैक के लिए [Agent Resources](/docs/agent-resources#global-resources) देखें।
