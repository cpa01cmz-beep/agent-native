...
<Diagram id="doc-block-1ji33rr" title={"मूल रेंडर पथ"} summary={"एक क्रिया रिटर्न JSON; रनटाइम एक स्पष्ट विजेट विवेचक या चैटयूआई.रेंडरर से मेल खाता है; AssistantChat एक वास्तविक React घटक स्थापित करता है। कोई आईफ्रेम नहीं, कोई HTML निष्पादन नहीं।"}>

```html
<div class="diagram-render">
  <div class="diagram-node">
    Action चलता है<br /><small class="diagram-muted"
      >संरचित JSON लौटाता है</small
    >
  </div>
  ...
  <div class="diagram-box">
    &lt;AssistantChat&gt;<br /><small class="diagram-muted"
      >React widget माउंट करता है</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
...
<Callout id="doc-block-zjr65h" tone="success">

रेंडरर तभी कार्यभार संभालता है जब कार्रवाई `chatUI` घोषित करती है **या** परिणाम में एक स्पष्ट ज्ञात `widget` विभेदक होता है। यह कभी भी मनमानी वस्तुओं को आकार नहीं देता है और टूल परिणामों से कभी भी HTML या JavaScript निष्पादित नहीं करता है - इसलिए एक मूल विजेट एक इंजेक्शन वेक्टर नहीं बन सकता है।
...
renderers का आकार प्रतिशत में नहीं, बल्कि निरपेक्ष इकाइयों में तय करें। ट्रांसक्रिप्ट अपने
संदेशों के अनुसार बढ़ता है, इसलिए renderer के कंटेनर की कोई निश्चित ऊँचाई नहीं होती जिसके
सापेक्ष प्रतिशत हल हो सके — चार्ट बार पर `height: 40%` त्रुटि देने के बजाय शून्य हो जाता है,
जो ऐसा दिखता है मानो renderer बना ही नहीं। चार्ट और ऊँचाई पर निर्भर अन्य दृश्यों को पिक्सेल
(या `rem`) आधार दें; चौड़ाई प्रतिशत में ठीक है क्योंकि ट्रांसक्रिप्ट कॉलम की चौड़ाई निश्चित होती है।
...
<Diagram id="doc-block-1kaurl9" title={"BYO रनटाइम Agent-Native चैट शेल रखता है"} summary={"आपका बाहरी एजेंट एक कनेक्टर के माध्यम से सामान्यीकृत घटनाओं को स्ट्रीम करता है; Agent-Native कंपोज़र, ट्रांसक्रिप्ट, टूल कार्ड, अनुमोदन और मूल विजेट रखता है।"}>

```html
<div class="diagram-byo">
  <div class="diagram-box" data-rough>
    आपका एजेंट<br /><small class="diagram-muted"
  ...
  <div class="diagram-panel center">
    ...
    ><small class="diagram-muted">सामान्यीकृत message-* / tool-* इवेंट</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card col">
...
- [Actions](/docs/actions-overview) - उन ऑपरेशनों को परिभाषित करें जो मूल विजेट डेटा लौटाते हैं।
