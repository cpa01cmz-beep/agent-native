...
description: "फ़्रेमवर्क में निर्मित परिचित और सुसंगत साझाकरण। उपयोगकर्ता द्वारा बनाए गए प्रत्येक संसाधन — दस्तावेज़, डैशबोर्ड, डिज़ाइन, डेक, क्लिप, रिकॉर्डिंग और फ़ॉर्म — को एक ही सुसंगत शेयर UI के साथ डिफ़ॉल्ट रूप से निजी मॉडल मिलता है।"
---

# साझाकरण एवं गोपनीयता

प्रत्येक संसाधन जो उपयोगकर्ता एजेंट-नेटिव ऐप में बनाता है - एक दस्तावेज़, एक डैशबोर्ड, एक डिज़ाइन, एक डेक, एक स्क्रीन रिकॉर्डिंग, एक मीटिंग ट्रांसक्रिप्ट, एक फॉर्म, एक बुकिंग लिंक - **डिफ़ॉल्ट रूप से निर्माता के लिए निजी है**। अन्य लोग इसे तभी देखते हैं जब निर्माता इसे स्पष्ट रूप से साझा करता है, या इसकी दृश्यता को `org` या `public` में बदल देता है।

हर जगह एक ही परिचित साझाकरण मॉडल है: वही शेयर बटन, वही संवाद, वही तीन-स्तरीय दृश्यता मॉडल और वही प्रति-उपयोगकर्ता/प्रति-संगठन अनुदान — हर टेम्पलेट में, प्रति-ऐप पुनर्निर्माण के बिना।
...
<Diagram id="doc-block-sv2bwb" title={"दृश्यता, बाहर की ओर चौड़ी होना"} summary={"संसाधन पर अस्पष्ट दृश्यता मंजिल निर्धारित करती है; सहयोगी तालिका में स्पष्ट शेयर अनुदान नामित लोगों को शीर्ष पर जोड़ें।"}>
...
- **टिप्पणीकार** — पढ़ सकते हैं और टिप्पणियां जोड़ सकते हैं, लेकिन संसाधन को संपादित या शेयर प्रबंधित नहीं कर सकते।
- **संपादक** - पढ़ें + लिखें।
...
- **व्यक्तिगत-डेटा ऐप्स** (मेल) - डिज़ाइन के अनुसार उपयोगकर्ता के दायरे में। कोई "मेरा इनबॉक्स साझा करें" अवधारणा नहीं है।
...
- व्यक्तिगत ईमेल अनुदानों के लिए `लोगों को सूचित करें` चेकबॉक्स।
...
<DataModel
  id="doc-block-8dw6dq"
  title={"संसाधन + सहयोगी शेयर तालिका"}
  summary={
  ...
  entities={[
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "text",
          nullable: false,
          note: "स्वामित्व के लिए सत्य का एकल स्रोत।",
        },
        {
          name: "org_id",
          type: "text",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "role",
          type: "enum",
          note: "दर्शक | टिप्पणीकार | संपादक | व्यवस्थापक",
        },
        {
          name: "created_by",
          type: "text",
...
## आगे क्या है {#see-also}

- [**सुरक्षा — डेटा स्कोपिंग**](/docs/security#data-scoping) — एक्सेस-फ़िल्टर और स्वामित्व मॉडल जिस पर साझाकरण आधारित है
- [**प्रमाणीकरण**](/docs/authentication) — सत्र, संगठन और अनुरोध संदर्भ में पहचान का प्रवाह
- [**Extensions**](/docs/extensions#sharing) — सैंडबॉक्स किए गए मिनी-ऐप सतह में साझाकरण
- [**टेम्पलेट बनाना**](/docs/creating-templates) — नए टेम्पलेट की स्कीमा में `ownableColumns` जोड़ना
