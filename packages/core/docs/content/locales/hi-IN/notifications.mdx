...
<Diagram id="doc-block-169a9i7" title={"एक कॉल, अनेक मंजिलें"} summary={"सूचित करें() हमेशा मालिक-स्कोप वाली इनबॉक्स पंक्ति लिखता है, प्रत्येक पंजीकृत चैनल को समानांतर (सर्वोत्तम प्रयास) में प्रशंसक बनाता है, फिर इवेंट बस पर अधिसूचना भेजता है।"}>
...
ईमेल, Slack और webhook हमेशा इनबॉक्स के साथ पंजीकृत होते हैं। डिलीवरी पहले प्रति-सूचना मेटाडेटा URL/प्राप्तकर्ताओं को चुनती है, फिर संबंधित env var पर वापस जाती है। यदि दोनों में से कोई भी सेट नहीं है, तो वह चैनल उत्सर्जन के लिए कुछ नहीं करता।
...
<Diagram id="doc-block-1qzciak" title={"चैनल और गंभीरता"} summary={"इनबॉक्स हमेशा चालू रहता है; वेबहुक को एक env var की आवश्यकता है; कस्टम चैनल स्टार्टअप पर पंजीकृत होते हैं। गंभीरता बैज स्टाइलिंग को संचालित करती है और इसे हर चैनल तक पहुंचाया जाता है।"}>
...
<div class="diagram-channels">
  ...
  <div class="diagram-panel col" data-rough>
    <strong>गंभीरता badge चलाती है</strong>
    <div class="sev-row">
      <span class="diagram-pill">info</span
      ><span class="diagram-muted">पुष्टियां, FYI</span>
    </div>
    <div class="sev-row">
...
<Endpoint id="doc-block-xntybj" title={"सूचनाएँ सूचीबद्ध करें"} method="GET" path={"/_agent-native/notifications?unread=true&limit=50&before=ISO"} summary={"वर्तमान उपयोगकर्ता के लिए हाल की सूचनाएं सूचीबद्ध करें"} auth={"Authenticated session; results are scoped to the session's email."} params={[
  {
    "name": "unread",
    "in": "query",
    "type": "boolean",
  ...
  },
  {
    ...
    "type": "string",
    "required": false,
    "description": "ISO टाइमस्टैम्प कर्सर — पेजिनेशन के लिए इस समय से पहले बनाई गई सूचनाएँ लौटाता है।"
  }
]} responses={[
  {
    "status": "200",
...
- **पोल एकीकरण** - प्रत्येक उत्परिवर्तन `recordChange()` को कॉल करता है इसलिए [`useDbSync`](/docs/client-data#usedbsync) का उपयोग करने वाले टेम्पलेट बिना किसी अतिरिक्त वायरिंग के स्वतः-अमान्य हो जाते हैं।
...
- [**Server plugins**](/docs/server-overview) - जहां कस्टम चैनल स्टार्टअप पर पंजीकृत होते हैं
