...
description: "बहु-उपयोगकर्ता सहयोगात्मक संपादन जहां AI एजेंट प्रथम श्रेणी का सहकर्मी है: CRDT विलय, लाइव उपस्थिति, SSE फास्ट-पाथ, और ग्रैन्युलर सर्वर-साइड मर्ज - PostgreSQL/PGlite और किसी भी होस्ट पर।"
---
...
- **हर जगह काम करता है** - PostgreSQL/PGlite।
...
तालिका फ़्रेमवर्क-प्रबंधित और प्रदाता-अज्ञेयवादी है (PGlite और Postgres उपयोग
...
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **सार्वजनिक रूप से पहुँच योग्य होस्ट पर Postgres**                                 | गेटवे अपने नेटवर्क से डेटाबेस को डायल करता है। PGlite, `localhost`, `*.internal` और सीधे IP पते तब ही अस्वीकार कर दिए जाते हैं जब PostgreSQL कनेक्शन स्ट्रिंग आपकी मशीन से निकली भी नहीं होती। | `DATABASE_URL` Neon जैसे मैनेज्ड Postgres की ओर इंगित करता हो                                                                                                                                        |
...
ऐप अपनी PostgreSQL कनेक्शन स्ट्रिंग और सार्वजनिक ओरिजिन भेजता है, बदले में चैनल ID और साइनिंग
...
**स्व-पंजीकरण का अर्थ है Builder को अपनी PostgreSQL कनेक्शन स्ट्रिंग भेजना।** Builder
