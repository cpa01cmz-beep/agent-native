...
<Diagram id="doc-block-bztrc8" title={"निश्चित इनपुट से लेकर तैनाती गेट तक"} summary={"रनर वास्तव में प्रत्येक मामले पर एजेंट लूप चलाता है, आउटपुट स्कोर करता है, और यदि कोई स्कोरर सीमा से नीचे आता है तो गैर-शून्य से बाहर निकल जाता है - जिससे यह ड्रॉप-इन सीआई गेट बन जाता है।"}>
...
<div class="eval-flow">
  ...
  <div class="diagram-node">
    एजेंट लूप चलाएँ<br /><small class="diagram-muted">real engine/model</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-node">
...
<Diagram id="doc-block-xk3owf" title={"4-चरणीय स्कोरर पाइपलाइन"} summary={"पहचान के लिए पूर्वप्रक्रिया और डिफ़ॉल्ट का विश्लेषण; केवल जेनरेटस्कोर आवश्यक है। विश्लेषण सादा JS चला सकता है या ctx के माध्यम से LLM जज को कॉल कर सकता है।"}>
...
agent-native eval billing            # केवल फ़ाइलें जिनके पथ में "billing" है
...
- [**Actions**](/docs/actions-overview) - उपकरण/actions जो `toolCalls` में दिखाई देते हैं
