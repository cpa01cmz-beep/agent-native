...
फ्रेमवर्क यह सब स्वचालित रूप से संभालता है। Builder-कनेक्टेड उपयोगकर्ताओं (free tier उपलब्ध) को डिफ़ॉल्ट रूप से Builder-होस्टेड जेमिनी फ्लैश-लाइट मिलता है; अन्यथा उपयोगकर्ता अपनी स्वयं की प्रदाता कुंजी ला सकते हैं या ब्राउज़र वाक् पहचान पर वापस आ सकते हैं।
...
1. **Builder जेमिनी फ्लैश-लाइट (Builder कनेक्ट होने पर डिफ़ॉल्ट)।** ब्राउज़र `/_agent-native/transcribe-voice` पर ऑडियो पोस्ट करता है, जो जेमिनी फ्लैश-लाइट का उपयोग करके Builder.io (free tier उपलब्ध) के माध्यम से प्रॉक्सी करता है। किसी Google API कुंजी की आवश्यकता नहीं है।
...
<Diagram id="doc-block-b8d74q" title={"वॉयस ट्रांसक्रिप्शन प्रदाता फ़ॉलबैक"} summary={"कंपोज़र ऑडियो रिकॉर्ड करता है, फिर सर्वर प्रदाताओं को क्रम में चलाता है, ब्राउज़र वेब स्पीच API पर तभी छोड़ता है जब कोई सर्वर प्रदाता उपलब्ध नहीं होता है।"}>

```html
<div class="diagram-voice">
  <div class="diagram-node">
    माइक बटन<br /><small class="diagram-muted">webm/opus रिकॉर्ड करता है</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card col">
    <div class="diagram-pill accent">1 &middot; Builder Gemini</div>
    <small class="diagram-muted">Builder कनेक्ट होने पर डिफ़ॉल्ट</small>
...
Builder सबसे आसान रास्ता है: सेटिंग्स से Builder.io (free tier उपलब्ध) कनेक्ट करें और डिफ़ॉल्ट प्रदाता Builder जेमिनी फ्लैश-लाइट बन जाता है। BYOK प्रदाताओं के लिए, सेटिंग्स → API कुंजी में मिलान कुंजी जोड़ें।
...
<Callout id="doc-block-1qmn8zo" tone="info">
...
<Endpoint id="doc-block-1rngg8k" title={"ध्वनि प्रतिलेखन मार्ग"} method="POST" path="/_agent-native/transcribe-voice" summary={"रिकॉर्ड किए गए ऑडियो क्लिप को प्रॉम्प्ट टेक्स्ट में ट्रांसक्राइब करें"} auth="Active session (Better Auth cookie). Same-origin only." params={[
  {
    "name": "audio",
    "in": "body",
    "type": "file",
