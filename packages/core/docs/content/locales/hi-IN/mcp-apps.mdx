...
<Diagram id="doc-block-ituns6" title={"MCP ऐप एम्बेड राउंड-ट्रिप"} summary={"कार्रवाई का लिंक लक्ष्य एम्बेड लक्ष्य भी है। सक्षम होस्ट समान हस्ताक्षरित ऐप रूट इनलाइन लोड करते हैं; बाकी सभी लोग गहरे लिंक पर वापस आ जाते हैं।"}>
...
<div class="diagram-embed">
  ...
  <div class="diagram-card" data-rough>
    ...
    ><small class="diagram-muted">एक-बार SQL ticket बदलता है</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card" data-rough>
    <strong>Signed app route</strong
    ><span class="diagram-pill ok">वास्तविक React रूट</span
    ><small class="diagram-muted">short-lived browser session</small>
  </div>
  <div class="diagram-fallback">
    <span class="diagram-pill warn">MCP Apps समर्थन नहीं</span>
...
<AnnotatedCode
  id="doc-block-1phws7e"
  title={"mcpApp संसाधन कॉन्फिगरेशन"}
  ...
  annotations={[
    {
      lines: "6",
      label: "प्रगतिशील वृद्धि",
      note: "`mcpApp.resource` उन होस्ट के लिए एक इनलाइन UI का विज्ञापन करता है जो MCP ऐप्स एक्सटेंशन का समर्थन करते हैं। कार्रवाई के `link` बिल्डर को भी रखें - CLI-केवल और पुराने होस्ट UI मेटाडेटा को अनदेखा करते हैं और अभी भी डीप लिंक की आवश्यकता है।",
    },
    {
      lines: "7",
    ...
    {
      lines: "11",
      label: "यूनिवर्सल फ़ॉलबैक लेबल",
      note: '`openLabel` वह दिखाई देने वाला `"Open in … →"` पाठ है, जिसका उपयोग तब डीप-लिंक निकास के रूप में होता है जब कोई होस्ट इनलाइन iframe रेंडर नहीं करता।',
    },
  ]}
/>
...
<Diagram id="doc-block-18nvyhx" title={"दो मेजबान पुल पथ, एक हस्ताक्षरित मार्ग"} summary={"क्लाउड हाइड्रेटेड मार्ग को ट्रांसप्लांट करता है और प्रत्यक्ष ui/_bridge का उपयोग करता है; ChatGPT को window.openai के माध्यम से एक नियंत्रित iframe मिलता है और पोस्टमैसेज पर होस्ट क्रियाओं को रिले करता है। दोनों एक ही हस्ताक्षरित ऐप रूट की ओर इशारा करते हैं।"}>
...
<div class="diagram-bridge">
  <div class="diagram-col">
    <div class="diagram-card" data-rough>
      ...
      ><small class="diagram-muted"
        >Claude के iframe में signed app HTML hydrate करता है, फिर direct `ui/_`
        host bridge</small
      >
    </div>
    <div class="diagram-card" data-rough>
  ...
  <div class="diagram-box" data-rough>
    Same signed app route<br /><small class="diagram-muted"
      >सामान्य route + React components</small
    >
  </div>
</div>
```
...
- [Actions](/docs/actions-overview) - `defineAction`, `link` बिल्डर, `publicAgent`।
