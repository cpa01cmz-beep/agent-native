...
<Diagram id="doc-block-1n738fz" title={"जहां तीन हुक दौड़कर फायर करते हैं"} summary={"processOutputStream प्रत्येक भाग को देखता है, processOutputStep प्रति प्रतिक्रिया के लिए टूल कॉल को गेट करता है, processOutputResult अंत में एक निर्णय रिकॉर्ड करता है। कोई भी हुक TripWire के साथ समाप्त हो सकता है।"}>
...
<div class="diagram-proc">
  ...
  <div class="diagram-node" data-rough>
    per model response<br /><small class="diagram-muted"
      >processOutputStep — टूल कॉल गेट करता है</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-node" data-rough>
    run end<br /><small class="diagram-muted"
      >processOutputResult — निर्णय</small
    >
  </div>
...
एक प्रोसेसर **कॉन्फिगरेशन** है, एक उपकरण नहीं, एक क्रिया नहीं, और एक संलेखन DSL नहीं है। प्रोसेसर केवल अपने स्वयं के स्ट्रीम-स्कोप्ड राज्य और `abort()` का निरीक्षण करते हैं, उन्हें बदलते हैं। वे कभी भी ऐप व्यवहार को परिभाषित नहीं करते हैं, actions को प्रतिस्थापित नहीं करते हैं, या मॉडल में दिखाई नहीं देते हैं। ऐप संचालन [actions](/docs/actions-overview) से संबंधित है।
