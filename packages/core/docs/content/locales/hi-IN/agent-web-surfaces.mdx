...
<Diagram id="doc-block-4ng9ra" title={"सार्वजनिक मार्ग क्या प्रकाशित करता है"} summary={"एक सार्वजनिक मार्ग एजेंट-अनुकूल अभ्यावेदन को बढ़ावा देता है। रूट पढ़ना कॉलिंग टूल से अलग है - टूल एक्सेस ऑप्ट-इन रहता है।"}>

```html
<div class="diagram-web">
  <div class="diagram-box" data-rough>
    सार्वजनिक रूट<br /><small class="diagram-muted"
  ...
  <div class="diagram-col gate">
    <span class="diagram-pill warn">टूल निजी रहते हैं</span
...
<AnnotatedCode
  id="doc-block-99ub1i"
  title={"सार्वजनिक सतह पर एक सुरक्षित कार्रवाई का विकल्प चुनना"}
  ...
  annotations={[
    ...
    {
      lines: "5-7",
      label: "स्व-वर्णन सुरक्षा",
      note: "इसे केवल पढ़ने के लिए चिह्नित करें, घोषित करें कि क्या इसे प्रमाणीकरण की आवश्यकता है, और ध्वजांकित करें कि क्या यह परिणामी है। सार्वजनिक MCP consequential/write कार्यों को तब तक बाहर करता है जब तक कि नीति स्पष्ट रूप से उन्हें अनुमति न दे।",
    },
  ]}
/>
...
- [**Actions**](/docs/actions-overview) - सार्वजनिक एजेंट प्रोटोकॉल में actions को कैसे चुनें
