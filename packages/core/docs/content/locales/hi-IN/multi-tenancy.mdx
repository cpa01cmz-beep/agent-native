...
एक ताज़ा `npx --yes @agent-native/core@latest create` मचान पहले से ही भेजा जा रहा है:
...
यदि आप CRM, प्रोजेक्ट ट्रैकर, सपोर्ट इनबॉक्स, या किसी टीम टूल के लिए एजेंट-नेटिव का मूल्यांकन कर रहे हैं, तो मल्टी-टेनेंट फाउंडेशन पहले से ही मौजूद है। सभी प्रथम-पक्ष टेम्पलेट बहु-किरायेदार हैं - सूची के लिए [टेम्पलेट](/docs/cloneable-saas) देखें।

<Diagram id="doc-block-1kxug4w" title={"संगठन की सदस्यता और अलगाव"} summary={"उपयोगकर्ता owner/admin/member के रूप में संगठनों से जुड़ते हैं। प्रत्येक स्वामित्व योग्य पंक्ति उस किरायेदार की org_id को वहन करती है जो उसका मालिक है, और कोई भी पंक्ति सीमा के पार लीक नहीं होती है।"}>

```html
<div class="mt-grid">
  <div class="diagram-card">
    <span class="diagram-pill accent">संगठन A</span
    ><small class="diagram-muted">members: alice (owner), bob (member)</small>
    <div class="diagram-box">rows where org_id = A</div>
  </div>
  <div class="diagram-card">
    <span class="diagram-pill accent">संगठन B</span
...
<Diagram id="doc-block-75069" title={"सत्र से दायरे तक SQL"} summary={"सत्र पर सक्रिय संगठन AGENT_ORG_ID बन जाता है, जिसे फ्रेमवर्क प्रत्येक क्वेरी के WHERE खंड में बदल देता है।"}>
...
- [**Authentication**](/docs/authentication#organizations) — sessions, social providers और organization-management surface
- [**Security — Data Scoping**](/docs/security#data-scoping) — SQL-level isolation, `ownableColumns()` contract और access guards
- [**Multi-App Workspace**](/docs/multi-app-workspace) — साझा authentication और RBAC के साथ एक monorepo में कई Agent-Native ऐप्स होस्ट करना

## आइसोलेशन मॉडल

सर्वर रीड और राइट के लिए `accessFilter()` और `assertAccess()` का उपयोग करें। एजेंट SQL स्कोपिंग ownable tables के लिए अस्थायी फ़िल्टर किए गए views बनाती है। `pnpm guards` में unscoped-query जांच शामिल है। RLS अभी सक्रिय सुरक्षा परत नहीं है और इसे 1.0 के बाद hardening के रूप में नियोजित किया गया है। [प्रशासित डिप्लॉयमेंट](/docs/administered-deployments) देखें।
