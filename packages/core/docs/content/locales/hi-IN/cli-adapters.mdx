...
<Diagram id="doc-block-17539b" title={"CLI एडॉप्टर → रजिस्ट्री → एक्शन सतह"} summary={"ShellCliAdapter एक बाइनरी लपेटता है; CliRegistry खोज के लिए एडेप्टर एकत्र करती है; defineAction एजेंट + यूआई एक्शन सतह पर एक कॉल को उजागर करता है।"}>
...
- [**Actions**](/docs/actions-overview) - क्रिया सतह CLI एडेप्टर आमतौर पर लपेटे जाते हैं।
