...
Skills वे Markdown फ़ाइलें हैं जो एजेंट को विशिष्ट पैटर्न और वर्कफ़्लो का गहन ज्ञान देती हैं। हर नियम को एक ही सिस्टम प्रॉम्प्ट में भरने के बजाय, ज्ञान को केंद्रित फ़ाइलों में बाँटें जिन्हें एजेंट तभी लोड करता है जब किसी कार्य को वास्तव में उनकी ज़रूरत हो — इससे डिफ़ॉल्ट संदर्भ छोटा रहता है और एजेंट ज़रूरत पड़ने पर गहराई में जा सकता है।
...
मौजूदा app-backed skills में Plan के `visual-plan`, `visual-recap`, और `visualize-repo`, Design का `visual-edit`, Assets का `assets`, और repo-backed docs/blog/MDX editing के लिए `content` शामिल हैं।
...
`app-skill` पैकेज मानक Agent Plugin फ़ाइलें भी बनाते हैं। Skills और दूरस्थ Streamable HTTP MCP सर्वर आयात करने के लिए `agent-native plugin import <path> --into <workspace> --yes` चलाएँ; पैकेज हेडर अनदेखे किए जाते हैं और stdio तथा SSE सर्वर बताए जाकर छोड़ दिए जाते हैं।
...
- मार्गदर्शन एकबारगी है - इसे इसके बजाय `AGENTS.md` या एजेंट मेमोरी में डालें
...
यदि ज्ञान ऐप में काम करने वाले प्रत्येक व्यक्ति पर लागू होता है ("हमेशा सबक्वेरीज़ पर सीटीई को प्राथमिकता दें"), तो यह एक कौशल या साझा `LEARNINGS.md` है। यदि यह _इस विशेष उपयोगकर्ता_ ("स्टीव को संक्षिप्त उत्तर पसंद है") के बारे में है, तो यह `memory/MEMORY.md` में आता है। संपूर्ण उपचार के लिए [एजेंट संसाधन — मेमोरी](/docs/agent-resources#memory) देखें।

## Skills बनाम SQL संसाधन {#skills-vs-resources}

यह पृष्ठ skill को `.agents/skills/<name>/SKILL.md` में एक फ़ाइल के रूप में प्रस्तुत करता है। [एजेंट संसाधन](/docs/agent-resources#skills) उसी skill को `skills/<slug>/SKILL.md` पथ पर workspace/shared/personal दायरे वाले SQL संसाधन के रूप में प्रस्तुत करता है। ये दो दृष्टिकोणों से एक ही अवधारणा हैं: Code मोड फ़ाइल को सीधे पढ़ता और लिखता है; App मोड इसे संसाधन पंक्ति के रूप में संग्रहीत करता है ताकि यह फ़ाइल सिस्टम के बिना काम करे। दोनों स्थितियों में सामग्री इस पृष्ठ के प्रारूप में लिखें।

## ऐप-समर्थित skills — पूर्ण विवरण {#app-backed-skills-full}

[ऐप-समर्थित skills](#app-backed-skills) के पीछे के मैनिफ़ेस्ट प्रारूप, CLI कमांड, मार्केटप्लेस एडेप्टर और ऑटो-अपडेट हैशिंग का पूरा विवरण:
...
- [**एजेंट निर्देश लिखना**](/docs/writing-agent-instructions) — skill विवरण लिखें और मार्गदर्शन को AGENTS.md, skills और मेमोरी में बाँटें
- [**एजेंट संसाधन**](/docs/agent-resources#skills) — App मोड में skills SQL संसाधनों के रूप में कहाँ रहते हैं
- [**एजेंट उल्लेख**](/docs/agent-mentions) — चैट में skill को चलाने वाला `/` कमांड ट्रिगर
- [**Plan प्लगइन और मार्केटप्लेस**](/docs/plan-plugin) — वास्तविक ऐप-समर्थित skill का शुरू से अंत तक इंस्टॉल और ऑटो-अपडेट प्रवाह
