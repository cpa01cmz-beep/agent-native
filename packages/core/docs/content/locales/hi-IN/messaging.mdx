...
- **चैनल उल्लेख** - काम शुरू करने के लिए @mention करें। जिस चैनल संदेश को एजेंट को संसाधित करना हो उसमें उसका स्पष्ट उल्लेख होना चाहिए; सामान्य थ्रेड उत्तर और चैनल की सामान्य बातचीत एजेंट को नहीं बुलाती।
...
प्रबंधित OAuth अनुशंसित सेटअप है। **एडमिन → मैसेजिंग** में **Agent manifest**
...
`app_home_opened`, `app_context_changed`, `app_mention` और `message.im` की सदस्यता लें।
`SLACK_CLIENT_ID`, `SLACK_CLIENT_SECRET` और `SLACK_SIGNING_SECRET`
सेट करने के बाद **एडमिन → मैसेजिंग** में **Add to Slack** चुनें। हर इंस्टॉल का
...
चैनल संदेश में एजेंट का स्पष्ट उल्लेख होना चाहिए; सामान्य थ्रेड उत्तर और सामान्य चैनल
बातचीत एजेंट को नहीं बुलाती। सीमित संदर्भ में प्रतिक्रियाएँ और फ़ाइल संदर्भ आते हैं, और नेटिव कार्ड योजना,
...
- उसी थ्रेड में बाद के हर संदेश में एजेंट का स्पष्ट उल्लेख होना चाहिए; सामान्य उत्तर एजेंट तक नहीं पहुँचता। हर नए अनुरोध के लिए दोबारा @mention करें।
...
| एक बार चला, फिर थ्रेड का अगला उत्तर अनदेखा हो गया             | यह अपेक्षित है। एजेंट को संसाधित करने के लिए हर संदेश में उसका स्पष्ट उल्लेख होना चाहिए — दोबारा @mention करें।                                              |
...
- **क्लिक्स, कॉन्फिगरेशन नहीं।** डिस्पैच की **एडमिन → मैसेजिंग** पेज में हर प्लेटफॉर्म के लिए कनेक्ट बटन हैं जिनमें एनवी-वेर फ़ील्ड्स अंतर्निहित हैं।
