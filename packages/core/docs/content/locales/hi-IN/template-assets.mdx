...
एसेट्स ब्रांड-संगत मीडिया बनाने और प्रबंधित करने के लिए एक एजेंट-मूल कार्यक्षेत्र है, खासकर तब जब इमेज या वीडियो मॉडल स्पष्ट रूप से बेहतर हों। यह अपलोड और उत्पन्न परिणामों को पुस्तकालयों और फ़ोल्डरों में व्यवस्थित करता है, टीमों को उत्पाद शॉट्स, लोगो, सोशल इमेज, फोटोरियलिस्टिक दृश्यों और अन्य मीडिया के स्वीकृत संदर्भ एकत्र करने देता है, ताकि उन्हें Design कंपोज़िशन या किसी अन्य जगह इस्तेमाल किया जा सके, फिर एजेंट चैट के माध्यम से पीढ़ी को रूट करता है ताकि प्रत्येक संपत्ति की समीक्षा और परिष्कृत किया जा सके।

<WireframeBlock id="doc-block-gggtpp">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1vj4lnd" title={"उत्पन्न करें, समीक्षा करें, पुन: उपयोग करें"} summary={"सन्दर्भ और संकेत एक उत्पन्न-और-चुनें सत्र फ़ीड करते हैं; चुनी गई संपत्तियाँ एक लाइब्रेरी में आती हैं और पिकर या A2A के माध्यम से अन्य ऐप्स में प्रवाहित होती हैं।"}>
...
<div class="diagram-assets">
  <div class="diagram-col">
    <div class="diagram-node">
      References<br /><small class="diagram-muted"
        >लोगो, उत्पाद चित्र, शैली</small
      >
    </div>
    <div class="diagram-node">
      प्रॉम्प्ट<br /><small class="diagram-muted"
        >chat या Generate controls</small
      >
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    <span class="diagram-pill accent">जनरेशन session</span
  ...
  <div class="diagram-box" data-rough>
    ...
    ><small class="diagram-muted">चुने हुए, brand-consistent assets</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-node">
    ...
    <div class="diagram-node">
      A2A<br /><small class="diagram-muted">स्लाइड · डिजाइन · सामग्री</small>
    </div>
  </div>
</div>
```
...
अधिकांश दृश्य कार्यों के लिए **Design** का उपयोग करें। लैंडिंग पेज, विज्ञापन, आरेख और अन्य कंपोज़िशन के लिए वहीं से शुरू करें, जब आपको HTML/CSS, सटीक लेआउट, संपादन योग्य संरचना या किसी डिज़ाइन टूल में इंपोर्ट/एक्सपोर्ट चाहिए।

**Assets** का उपयोग तब करें जब इमेज या वीडियो मॉडल काम के लिए बेहतर हों और परिणाम को मीडिया की तरह इस्तेमाल किया जा सके, टुकड़ा-टुकड़ा संपादित न करना पड़े। इसमें फोटोरियलिस्टिक या पिक्सेल-आधारित इमेज, प्रोडक्ट शॉट्स, सोशल इमेज और वीडियो शामिल हैं। हाथ से बने या Excalidraw-शैली के आरेख अपवाद हो सकते हैं, जब आप बनी हुई इमेज को उसी रूप में इस्तेमाल करना चाहते हों।

अपेक्षित workflow Design से शुरू होता है। जब PNG या कोई अन्य मीडिया एसेट सही विकल्प हो, तो Design agent सहायक इमेज जनरेशन को Assets को सौंप सकता है। इसके बाद परिणाम को Design कंपोज़िशन या किसी अन्य ऐप में इस्तेमाल करें।
...
<DataModel
  id="doc-block-16dezjj"
  title={"संपत्ति डेटा मॉडल"}
  summary={
  ...
  entities={[
    {
      ...
      note: "शीर्ष-स्तरीय स्वामित्व योग्य कंटेनर",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "पुनरावृत्तीय उत्पन्न-और-चुनें",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "एक सत्र में उम्मीदवार की संपत्ति",
      fields: [
        {
          name: "session_id",
          type: "id",
