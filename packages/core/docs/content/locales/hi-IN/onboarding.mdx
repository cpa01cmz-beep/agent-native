...
<Diagram id="doc-block-achnga" title={"सेटअप चेकलिस्ट"} summary={"केवल AI इंजन कनेक्ट करना आवश्यक है। पैनल पूर्णता को ट्रैक करता है और सभी आवश्यक चीजें पूरी हो जाने पर स्वतः छिप जाता है।"}>

```html
<div class="ob">
  <div class="diagram-card">
    <span class="diagram-pill warn">required</span
    ><strong>AI इंजन कनेक्ट करें</strong
  ...
  <div class="diagram-card">
    <span class="diagram-pill">optional</span><strong>ईमेल डिलीवरी</strong
...
<Endpoint id="doc-block-ut874q" title={"ऑनबोर्डिंग चरणों की सूची बनाएं"} method="GET" path="/_agent-native/onboarding/steps" summary={"सभी पंजीकृत चरणों को उनकी पूर्णता स्थिति के साथ सूचीबद्ध करें"} responses={[
  {
    "status": "200",
...
<AnnotatedCode
  id="doc-block-kly1t5"
  title={"एक कस्टम ऑनबोर्डिंग चरण पंजीकृत करना"}
  ...
  annotations={[
    {
      lines: "5",
      label: "ऑटो-माउंटेड",
      note: "Nitro प्लगइन से रजिस्टर करें - फ्रेमवर्क रेंडरिंग, पूर्णता ट्रैकिंग और बर्खास्तगी को संभालता है।",
    },
    {
      lines: "7",
      label: "स्टैक आईडी",
      note: "डिफ़ॉल्ट लोड के बाद उसी `id` के साथ पुनः पंजीकरण करना एक अंतर्निहित चरण को ओवरराइड करता है।",
    },
    {
      lines: "12-19",
      label: "प्राथमिक विधि",
    ...
    },
    {
      lines: "20-26",
      label: "प्रतिनिधि पथ",
      note: '`kind: "agent-task"` सेटअप को एक प्रॉम्प्ट के साथ एजेंट चैट को सौंपता है।',
    },
    {
      lines: "28-31",
      label: "समापन जांच",
      note: "`isComplete` सर्वर-साइड चलता है। OAuth टोकन `oauth_tokens` स्टोर में रहते हैं - इसे जांचें, `process.env.GMAIL_REFRESH_TOKEN` नहीं।",
    },
  ]}
/>
...
| `database` | नहीं   | Hosted PostgreSQL URL या local PGlite के लिए खाली छोड़ें |
