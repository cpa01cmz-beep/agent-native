...
<Diagram id="doc-block-bkcsek" title={"一间经营商店三层"} summary={"CLI、Desktop 和共享 UI 是同一文件支持的运行存储和执行器上的不同表面；主机通过 CodeAgentsHost 合约对其进行调整。"}>
...
<div class="diagram-layers">
  <div class="diagram-row">
    <div class="diagram-card" data-rough>
      ...
      ><small class="diagram-muted">启动 · 恢复 · 状态 · 停止</small>
    </div>
    <div class="diagram-card" data-rough>
      <span class="diagram-pill">Desktop</span
      ><small class="diagram-muted">原生终端 · webviews · 深链接</small>
    </div>
    <div class="diagram-card" data-rough>
  ...
  <div class="diagram-box" data-rough>
    文件支持的运行存储 + 执行器<br /><small class="diagram-muted"
...
[Harness Agents](/docs/harness-agents)；该适配器现在会在主机上解析受支持的原生订阅
凭据，无需将本地身份验证文件复制到沙箱中。
...
<Diagram id="doc-block-xtmvmh" title={"远程 Dispatch 仅限出站"} summary={"移动设备从不直接与桌面对话。 Desktop 长轮询 Dispatch，声明命令，驱动本地运行存储，并将结果镜像回来。"}>

```html
<div class="diagram-remote">
  <div class="diagram-node" data-rough>
    移动端 / Telegram<br /><small class="diagram-muted">/code · 会话</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    Dispatch 中继<br /><small class="diagram-muted">主机 · 运行 · 转录</small>
  </div>
...
<Endpoint id="doc-block-1ocymjy" title={"桌面声明排队的工作"} method="POST" path="/_agent-native/integrations/remote/poll" summary={"桌面长轮询中继以声明排队的命令"} auth="Desktop device token" responses={[
  {
    "status": "200",
