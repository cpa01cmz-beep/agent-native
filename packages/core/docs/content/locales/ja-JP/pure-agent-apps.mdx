...
- [**Actions**](/docs/actions-overview) — automation-first app が呼び出すツール

新しい headless アプリを作成するには、`npx --yes @agent-native/core@latest create my-agent --headless` を使用してください。
