...
- [**Actions**](/docs/actions-overview) — as ferramentas que seu agente puro chamará

Para criar um novo app headless, use `npx --yes @agent-native/core@latest create my-agent --headless`.
