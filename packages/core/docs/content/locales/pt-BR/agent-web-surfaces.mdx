...
<Diagram id="doc-block-wfes97" title={"O que uma rota pública publica"} summary={"Uma rota pública se transforma em representações amigáveis ​​aos agentes. A leitura da rota é separada da chamada de ferramentas – o acesso à ferramenta permanece opcional."}>

```html
<div class="diagram-web">
  <div class="diagram-box" data-rough>
    Rota pública<br /><small class="diagram-muted"
  ...
  <div class="diagram-col gate">
    <span class="diagram-pill warn">Ferramentas continuam privadas</span
...
<AnnotatedCode
  id="doc-block-1lq2cm3"
  title={"Optando por uma ação segura na superfície pública"}
  ...
  annotations={[
    ...
    {
      lines: "5-7",
      label: "Autodescrever segurança",
      note: "Marque-o como somente leitura, declare se ele precisa de autenticação e sinalize se é consequencial. MCP público exclui ações consequential/write, a menos que a política as permita explicitamente.",
    },
  ]}
/>
...
- [**Actions**](/docs/actions-overview) — como incluir actions no protocolo de agente público
