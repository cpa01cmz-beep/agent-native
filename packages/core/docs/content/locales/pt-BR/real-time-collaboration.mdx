...
description: "Edição colaborativa multiusuário onde o agente de IA é um par de primeira classe: mesclagem CRDT, presença ao vivo, acesso rápido SSE e mesclagem granular no lado do servidor — em PostgreSQL/PGlite e qualquer host."
---
...
- **Funciona em qualquer lugar** — PostgreSQL/PGlite.
...
A tabela é gerenciada pela estrutura e independente do provedor (uso de PGlite e Postgres
...
| --------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Postgres em um host publicamente acessível**                              | O gateway disca para o banco de dados a partir da própria rede. PGlite, `localhost`, `*.internal` e endereços IP nus são recusados antes que a string de conexão do PostgreSQL sequer saia da sua máquina. | `DATABASE_URL` aponta para um Postgres gerenciado, como o Neon                                                                                                                                       |
...
canal. O aplicativo envia sua string de conexão do PostgreSQL e sua origem pública, recebe de
...
**O autorregistro significa enviar ao Builder a string de conexão do PostgreSQL do seu banco
