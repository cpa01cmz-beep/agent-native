...
<Diagram id="doc-block-23xzov" title={"Duas camadas bloqueiam efeitos colaterais duplicados no currículo"} summary={"O diário lê o livro-razão durável e classifica as chamadas anteriores; a camada 1 informa ao modelo, a camada 2 bloqueia uma gravação reenviada que corresponde a uma entrada concluída."}>
...
<div class="diagram-durable">
  ...
  <div class="diagram-col">
    ...
    <div class="diagram-pill accent">
      Camada 2 · escrita redisparada com bloqueio rígido
    </div>
  </div>
</div>
```
...
- [**Actions**](/docs/actions-overview) — `readOnly` marca a leitura como segura para reexecução; todo o resto é tratado como efeito colateral.
