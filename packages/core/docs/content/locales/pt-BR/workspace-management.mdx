...
<Diagram id="doc-block-ps96tz" title={"Dois planos de governança"} summary={"Git governa o código; Dispatch rege o tempo de execução. Eles são complementares – não reproduzam um dentro do outro."}>

```html
<div class="gov">
  <div class="diagram-card">
    <span class="diagram-pill accent">Git e GitHub</span
    ><strong>Governança de código</strong>
    <div class="gov-list">
      <span class="diagram-pill">CODEOWNERS</span
      ><span class="diagram-pill">branch protection</span
      ><span class="diagram-pill">Revisão de PR</span
...
<FileTree
  id="doc-block-15icryg"
  title={"Configuração de governança no repo"}
  entries={[
    {
      path: ".github/CODEOWNERS",
      note: "Atribui reviewers automaticamente por caminho alterado",
    },
    {
      path: ".github/labeler.yml",
      note: "Aplica labels automaticamente aos PRs por app",
    },
    {
      path: "pnpm-workspace.yaml",
      note: "Nível de workspace: revisão ampla",
    },
    {
      path: "package.json",
      note: "Nível de workspace: propriedade do time de plataforma",
    },
  ]}
/>
...
| **Migrações de esquema**                    | Equipe da plataforma + engenheiro sênior                | Segurança de dados, compatibilidade com PostgreSQL                                 |
...
Para o modelo de recursos e caminhos canônicos, consulte [Recursos do Agente — Global resources](/docs/agent-resources#global-resources).

## Lista de verificação de configuração

Para um novo espaço de trabalho, após executar `npx --yes @agent-native/core@latest create`:
...
- [ ] Registre conexões de espaço de trabalho reutilizáveis para contas de provedor compartilhadas e, em seguida,
      ...
      essa conta
- [ ] Adicione skills para todo o espaço de trabalho, instruções de proteção e recursos de referência de marca/empresa por meio da página Recursos. Consulte [Recursos do Agente](/docs/agent-resources#global-resources) para obter a tabela completa de modelos de recursos e o pacote inicial recomendado.
