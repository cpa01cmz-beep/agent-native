...
- **Comentarista** — pode ler e adicionar comentários, mas não pode editar o recurso nem gerenciar compartilhamentos.
- **Editor** — ler + escrever.
...
- **Aplicativos de dados pessoais** como o Mail — com escopo definido pelo usuário por design. Não existe o conceito de "compartilhar minha caixa de entrada".
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "role",
          type: "enum",
          note: "visualizador | comentarista | editor | administrador",
        },
        {
          name: "created_by",
          type: "text",
