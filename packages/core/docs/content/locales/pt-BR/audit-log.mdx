...
- [**Actions**](/docs/actions-overview) — a costura `defineAction` onde a captura acontece
- [**Human-in-the-Loop Approvals**](/docs/actions-access-control#needs-approval) — actions fechado, registrado como `denied`
