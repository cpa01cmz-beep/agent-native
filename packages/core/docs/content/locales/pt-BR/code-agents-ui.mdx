...
<Diagram id="doc-block-1rst7t9" title={"Três camadas em uma loja de execução"} summary={"CLI, Desktop e a UI compartilhada são superfícies diferentes no mesmo armazenamento e executor de execução apoiado por arquivo; hosts o adaptam por meio do contrato CodeAgentsHost."}>
...
<div class="diagram-layers">
  <div class="diagram-row">
    <div class="diagram-card" data-rough>
      ...
      ><small class="diagram-muted">iniciar · retomar · status · parar</small>
    </div>
    <div class="diagram-card" data-rough>
      <span class="diagram-pill">Desktop</span
      ><small class="diagram-muted"
        >terminal nativo · webviews · deep links</small
      >
    </div>
    <div class="diagram-card" data-rough>
      <span class="diagram-pill accent">Compartilhard UI</span
  ...
  <div class="diagram-box" data-rough>
    Run store em arquivos + executor<br /><small class="diagram-muted"
...
[Harness Agents](/docs/harness-agents); esse adaptador agora resolve no host as
credenciais de assinatura nativas compatíveis sem copiar o arquivo de autenticação
local para o sandbox.
...
<Diagram id="doc-block-i6i62m" title={"Dispatch remoto é somente de saída"} summary={"O celular nunca se comunica diretamente com o desktop. Desktop faz pesquisas longas em Dispatch, reivindica comandos, direciona o armazenamento de execução local e espelha os resultados de volta."}>

```html
<div class="diagram-remote">
  <div class="diagram-node" data-rough>
    Celular / Telegram<br /><small class="diagram-muted">/code · sessões</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    Relay do Dispatch<br /><small class="diagram-muted"
      >hosts · execuções · transcrição</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&larr;</div>
  <div class="diagram-node" data-rough>
    Desktop<br /><small class="diagram-muted"
      >long-polls · assume · controla run store</small
    >
  </div>
</div>
```
...
<Endpoint id="doc-block-ss0jr4" title={"Trabalho na fila de declarações de desktop"} method="POST" path="/_agent-native/integrations/remote/poll" summary={"O desktop pesquisa longamente o relé para reivindicar comandos enfileirados"} auth="Desktop device token" responses={[
  {
    "status": "200",
