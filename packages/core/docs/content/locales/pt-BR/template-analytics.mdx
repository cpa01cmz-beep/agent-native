...
<WireframeBlock id="doc-block-1wcp66i">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1lfh70i" title={"Pergunta para traçar"} summary={"O agente consulta o dicionário de dados, escreve SQL, valida-o no armazém e depois renderiza um gráfico ou salva um painel."}>

```html
<div class="diagram-flow">
  <div class="diagram-node">Linguagem simples<br />question</div>
  ...
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>Grava SQL</div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-pill ok">Validar dry-run</div>
    <small class="diagram-muted">BigQuery / fonte</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box">Gráfico, tabela ou<br />saved panel</div>
</div>
```
...
<DataModel
  id="doc-block-12lqbu7"
  title={"Modelo de dados analíticos"}
  summary={
  ...
  entities={[
    {
      ...
      fields: [
        ...
        },
        {
          name: "config",
          type: "text",
          note: "JSON correspondente a SqlDashboardConfig",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "instructions",
          type: "text",
          note: "Execute novamente as etapas",
        },
        {
          name: "dataSources",
          type: "text",
...
Para um padrão mais amplo de extensão de modelos, consulte [Skills guide](/docs/skills-guide) e [Actions](/docs/actions-overview).
