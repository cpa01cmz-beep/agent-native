...
Assets é um espaço de trabalho nativo do agente para criar e gerenciar mídia consistente com a marca, especialmente quando os modelos de imagem ou vídeo têm uma vantagem clara. Ele organiza uploads e resultados gerados em bibliotecas e pastas, permite que as equipes coletem referências aprovadas de fotos de produtos, logotipos, imagens para redes sociais, cenas fotorrealistas e outras mídias para usar em uma composição do Design ou em outro lugar e, em seguida, roteia a geração por meio do chat do agente para que cada ativo possa ser revisado e refinado.

<WireframeBlock id="doc-block-1op1oht">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-zs0kh4" title="Gerar, revisar, reutilizar" summary={"Referências e prompts alimentam uma sessão de geração e escolha; os ativos escolhidos vão para uma biblioteca e fluem para outros aplicativos por meio do seletor ou A2A."}>
...
<div class="diagram-assets">
  <div class="diagram-col">
    <div class="diagram-node">
      References<br /><small class="diagram-muted"
        >logos, imagens de produto, estilo</small
      >
    </div>
    <div class="diagram-node">
      Prompt<br /><small class="diagram-muted"
        >chat ou controles Generate</small
      >
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    <span class="diagram-pill accent">Sessão de geração</span
  ...
  <div class="diagram-box" data-rough>
    ...
    ><small class="diagram-muted"
      >assets escolhidos e consistentes com a marca</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-node">
      Picker<br /><small class="diagram-muted">iframe / app MCP</small>
    </div>
    <div class="diagram-node">
      A2A<br /><small class="diagram-muted">Slides · Design · Conteúdo</small>
    </div>
  </div>
</div>
```
...
Use **Design** para a maior parte do trabalho visual. Comece por ele para landing pages, anúncios, diagramas e outras composições quando precisar de HTML/CSS, layout preciso, estrutura editável ou importação e exportação para uma ferramenta de design.

Use **Assets** quando os modelos de imagem ou vídeo forem mais adequados e o resultado puder ser usado como mídia, em vez de ser editado peça por peça. Isso inclui imagens fotorrealistas ou baseadas em pixels, fotos de produtos, imagens para redes sociais e vídeos. Diagramas desenhados à mão ou no estilo Excalidraw podem ser uma exceção quando você quiser usar a imagem gerada como está.

O fluxo desejado é começar no Design e deixar o agente do Design delegar a geração de imagens de apoio ao Assets quando um PNG ou outro recurso de mídia for a opção certa. Use o resultado na composição do Design ou em outro aplicativo.
...
<DataModel
  id="doc-block-19j1xeu"
  title="Modelo de dados de ativos"
  summary={
  ...
  entities={[
    {
      ...
      note: "Contêiner proprietário de nível superior",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Style/category agrupamentos",
      fields: [
        {
          name: "library_id",
          type: "id",
    ...
    },
    {
      ...
      note: "Receitas de geração salvas",
      fields: [
        {
          name: "media_type",
          type: "text",
    ...
    },
    {
      ...
      note: "Gerar e escolher iterativo",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Recursos candidatos em uma sessão",
      fields: [
        {
          name: "session_id",
          type: "id",
    ...
    },
    {
      ...
      note: "Log de auditoria de geração",
      fields: [
        {
          name: "model",
          type: "text",
