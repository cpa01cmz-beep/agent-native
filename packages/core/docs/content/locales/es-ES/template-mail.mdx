...
<WireframeBlock id="doc-block-bpy60t">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-z9ug9h" title={"Cómo fluye una solicitud por correo"} summary={"Los atajos de teclado y las indicaciones del agente ejecutan las mismas acciones. El correo electrónico vive en Gmail; borradores, automatizaciones y seguimiento en vivo en SQL y application_state."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      Tú controlas<br /><small class="diagram-muted">atajos J/K/E/R</small>
    </div>
    <div class="diagram-node">
      Le pides al agente<br /><small class="diagram-muted"
        >"redacta un rechazo amable"</small
      >
    </div>
  </div>
  ...
  <div class="diagram-col">
    <div class="diagram-box">
      Gmail<br /><small class="diagram-muted">varias cuentas, vía OAuth</small>
    </div>
    <div class="diagram-box">
      SQL + application_state<br /><small class="diagram-muted"
        >borradores · automatizaciones · seguimiento</small
      >
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&#8635;</div>
  <div class="diagram-box">La bandeja se actualiza en vivo</div>
</div>
```
...
<DataModel
  id="doc-block-1250khn"
  title="Tablas SQL de Mail"
  summary={
    "El correo electrónico en sí vive en Gmail. Las tablas SQL contienen lo que Gmail no contiene: borradores en cola, eventos de seguimiento de envío y tokens OAuth. La configuración y el estado efímero se encuentran en las tiendas de configuración y estado_aplicación."
  }
  entities={[
    {
...
Realice estos cambios en su repositorio y flujo de desarrollo. El agente integrado solo puede ayudar a editar el código fuente cuando el host concede intencionalmente herramientas de escritura de repository/workspace; de lo contrario, trabaja mediante actions y datos. Consulte [Key Concepts](/docs/key-concepts#agent-modifies-code).

## Qué sigue

- [**Plantillas**](/docs/cloneable-saas) — el modelo de clonar y poseer, y cualquier otra plantilla de dominio desde la que empezar
- [**Primeros pasos**](/docs/getting-started) — los fundamentos del marco: acciones, estado de la aplicación y sincronización en directo
- [**Calendario**](/docs/template-calendar) — una plantilla de dominio relacionada que cubre programación y reservas
- [**Automatizaciones**](/docs/automations) — el motor basado en eventos sobre el que se construyen las reglas de clasificación automática de Mail
- [**Acciones**](/docs/actions-overview) — el sistema de acciones que invocan el chat, los atajos y las automatizaciones
