...
<Diagram id="doc-block-1428q4k" title="De la fuente a la respuesta citada" summary="Brain ingiere fuentes aprobadas en capturas sin procesar, destila memoria duradera, la revisa y solo entonces responde con citas.">
...
<div class="diagram-flow">
  ...
  <div class="diagram-box" data-rough>
    Capturas sin procesar<br /><small class="diagram-muted"
      >deduplicado, redactado</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    Distill<br /><small class="diagram-muted"
      >hechos · decisiones · procesos</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card">
  ...
  <div class="diagram-box" data-rough>
    ...
    ><small class="diagram-muted">aprobado, atómico</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
...
<WireframeBlock id="doc-block-x27x9y">
  <Screen
    surface="desktop"
    html={
...
no se requiere una base de datos vectorial, por lo que la plantilla sigue siendo portátil en todo PGlite,
Postgres, Neon, hosted PostgreSQL y hosts similares. El estado de la aplicación refleja el
ruta actual, filtros e ID seleccionados para que el agente siempre conozca la ruta actual
navegación y selección.

El esquema del cerebro vive en `templates/brain/server/db/schema.ts`. Nueve tablas:
...
<DataModel
  id="doc-block-nm6bfy"
  title="Modelo de datos Brain"
  summary={
    "Los conectores producen capturas sin procesar; la destilación las convierte en conocimiento revisable; las propuestas protegen las entradas sensibles. Las ejecuciones de sincronización y la cola de ingesta rastrean el trabajo en segundo plano."
  }
  entities={[
    {
      id: "sources",
      name: "brain_sources",
      note: "Configuración del conector",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Cargas útiles sin procesar ingeridas",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Entradas atómicas destiladas",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Artículos pendientes de revisión",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Sincronizar registro de auditoría",
      fields: [
        {
          name: "source_id",
          type: "id",
    ...
    },
    {
      ...
      note: "Cola de destilación en segundo plano",
      fields: [
        {
          name: "operation",
          type: "text",
...
<Endpoint id="doc-block-1n5io9c" title="Webhook de ingesta firmado" summary={"Las importaciones Clips y transcript/capture genéricas publican un RawCapturePayload con un token al portador por fuente."} method="POST" path="/api/_agent-native/brain/ingest" summary={"Importe una captura sin procesar desde Clips o una fuente genérica"} auth={"Bearer <ingestToken> issued per source via its sourceKey"} request={{
...
Realiza estos cambios en el flujo de desarrollo del repositorio. El agente
integrado solo puede ayudar a editar el código fuente cuando el host concede
intencionalmente herramientas de escritura de repository/workspace; de lo
contrario, trabaja mediante actions y datos. Ver
...
- [**Recursos del Agente**](/docs/agent-resources): recursos compartidos entre aplicaciones
- [**A2A Protocol**](/docs/a2a-protocol): delegación entre aplicaciones
- [**Plantillas**](/docs/cloneable-saas) — el modelo de clonar y poseer, y todas las demás plantillas de dominio desde las que empezar
