...
Assets es un espacio de trabajo nativo del agente para crear y gestionar medios coherentes con la marca, especialmente cuando los modelos de imagen o vídeo ofrecen una ventaja clara. Organiza las cargas y los resultados generados en bibliotecas y carpetas, permite a los equipos recopilar referencias aprobadas de productos, logotipos, imágenes para redes sociales, escenas fotorrealistas y otros medios para usarlos en una composición de Design o en otro lugar, y luego dirige la generación a través del chat del agente para que cada activo pueda revisarse y perfeccionarse.

<WireframeBlock id="doc-block-1u8zywa">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1s9p1n2" title="Generar, revisar, reutilizar" summary={"Las referencias y las indicaciones alimentan una sesión de generar y elegir; Los activos elegidos aterrizan en una biblioteca y fluyen hacia otras aplicaciones a través del selector o A2A."}>
...
<div class="diagram-assets">
  <div class="diagram-col">
    <div class="diagram-node">
      References<br /><small class="diagram-muted"
        >logos, imágenes de producto, estilo</small
      >
    </div>
    <div class="diagram-node">
      Prompt<br /><small class="diagram-muted">chat o controles Generate</small>
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    <span class="diagram-pill accent">Sesión de generación</span
  ...
  <div class="diagram-box" data-rough>
    ...
    ><small class="diagram-muted"
      >assets elegidos y coherentes con la marca</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-node">
      Picker<br /><small class="diagram-muted">iframe / aplicación MCP</small>
    </div>
    <div class="diagram-node">
      A2A<br /><small class="diagram-muted"
        >Presentaciones · Diseño · Contenido</small
      >
    </div>
  </div>
</div>
...
## Assets frente a Design

Usa **Design** para la mayoría del trabajo visual. Empieza allí para páginas de destino, anuncios, diagramas y otras composiciones cuando necesites HTML/CSS, un diseño preciso, una estructura editable o importar y exportar desde una herramienta de diseño.

Usa **Assets** cuando los modelos de imagen o vídeo sean más adecuados para el trabajo y el resultado pueda utilizarse como medio en lugar de editarse pieza por pieza. Esto incluye imágenes fotorrealistas o basadas en píxeles, fotografías de productos, imágenes para redes sociales y vídeo. Los diagramas dibujados a mano o con estilo Excalidraw pueden ser una excepción cuando quieras usar la imagen generada tal cual.

El flujo previsto es empezar en Design y dejar que el agente de Design delegue la generación de imágenes auxiliares en Assets cuando un PNG u otro recurso multimedia sea lo adecuado. Usa el resultado en la composición de Design o en otra aplicación.
...
<DataModel
  id="doc-block-114ulf7"
  title="Modelo de datos Assets"
  summary={
    "Las bibliotecas son el contenedor con propietario; colecciones, carpetas y presets las organizan. Las sesiones impulsan generar-y-elegir; los assets y runs guardan la salida y el registro de auditoría. Los nombres de tabla conservan el prefijo heredado image_* pero cubren todos los medios."
  }
  entities={[
    {
      id: "library",
      name: "image_libraries",
      note: "Contenedor de propiedad de nivel superior",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Agrupaciones Style/category",
      fields: [
        {
          name: "library_id",
          type: "id",
    ...
    },
    {
      ...
      note: "Recetas de generación guardada",
      fields: [
        {
          name: "media_type",
          type: "text",
    ...
    },
    {
      ...
      note: "Generar y elegir iterativo",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Activos candidatos en una sesión",
      fields: [
        {
          name: "session_id",
          type: "id",
    ...
    },
    {
      ...
      note: "Registro de auditoría de generación",
      fields: [
        {
          name: "model",
          type: "text",
