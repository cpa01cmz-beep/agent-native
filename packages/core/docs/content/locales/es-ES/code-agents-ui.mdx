...
<Diagram id="doc-block-1pigctn" title="Tres capas en una sola tienda" summary={"CLI, Desktop y la interfaz de usuario compartida son superficies diferentes en el mismo almacén de ejecución y ejecutor respaldado por archivos; los hosts lo adaptan a través del contrato CodeAgentsHost."}>
...
<div class="diagram-layers">
  <div class="diagram-row">
    <div class="diagram-card" data-rough>
      ...
      ><small class="diagram-muted"
        >iniciar · reanudar · estado · detener</small
      >
    </div>
    <div class="diagram-card" data-rough>
      <span class="diagram-pill">Desktop</span
      ><small class="diagram-muted"
        >terminal nativo · webviews · enlaces profundos</small
      >
    </div>
    <div class="diagram-card" data-rough>
      <span class="diagram-pill accent">Compartird UI</span
  ...
  <div class="diagram-box" data-rough>
    Almacén de ejecuciones en archivos + ejecutor<br /><small
      class="diagram-muted"
...
[Harness Agents](/docs/harness-agents); ese adaptador ahora resuelve en el host las
credenciales de suscripción nativas compatibles sin copiar el archivo de autenticación
local al entorno sandbox.
...
<Diagram id="doc-block-1qkssr7" title="El Dispatch remoto es solo saliente" summary={"El móvil nunca habla directamente con el escritorio. Desktop realiza encuestas largas a Dispatch, reclama comandos, gestiona el almacén de ejecución local y refleja los resultados."}>

```html
<div class="diagram-remote">
  <div class="diagram-node" data-rough>
    Móvil / Telegram<br /><small class="diagram-muted">/code · sesiones</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    Relay de Dispatch<br /><small class="diagram-muted"
      >hosts · ejecuciones · transcripción</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&larr;</div>
  <div class="diagram-node" data-rough>
    Desktop<br /><small class="diagram-muted"
      >long-polls · reclama · dirige el almacén de ejecuciones</small
    >
  </div>
</div>
```
...
<Endpoint id="doc-block-1xqpgw5" title="Trabajo en cola de reclamaciones de escritorio" method="POST" path="/_agent-native/integrations/remote/poll" summary={"El escritorio realiza una encuesta prolongada al relé para reclamar comandos en cola"} auth="Desktop device token" responses={[
  {
    "status": "200",
