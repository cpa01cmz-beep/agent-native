...
<Diagram id="doc-block-vx4go0" title={"Adaptador CLI → registro → superficie de acción"} summary={"ShellCliAdapter envuelve un binario; CliRegistry recopila adaptadores para su descubrimiento; defineAction expone una llamada en la superficie de acción agente + UI."}>
...
- [**Actions**](/docs/actions-overview): la superficie de acción en la que normalmente se envuelven los adaptadores CLI.
