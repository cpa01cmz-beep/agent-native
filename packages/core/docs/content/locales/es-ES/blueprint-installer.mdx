...
<Diagram id="doc-block-r5iizh" title={"agregar imprime una receta; su agente codificador lo aplica"} summary={"agent-native emite un plano de Markdown para stdout (diagnóstico para stderr); lo canaliza a Claude Code o Codex, que edita su repositorio en vivo con contexto completo."}>
...
<div class="diagram-bp">
  ...
  <div class="diagram-box" data-rough>
    Blueprint Markdown<br /><small class="diagram-muted"
      >stdout · archivos por tocar · reglas · verificar</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-panel center" data-rough>
    Agente de código<br /><small class="diagram-muted">claude · codex</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
...
agent-native add <kind> <https://docs…>   # investigar e integrar desde un URL
...
- [**Actions**](/docs/actions-overview): la única fuente de verdad en la que se basa cada proyecto
