...
- [**Actions**](/docs/actions-overview): las herramientas que utilizará su agente puro

Para crear una nueva aplicación sin interfaz, usa `npx --yes @agent-native/core@latest create my-agent --headless`.
