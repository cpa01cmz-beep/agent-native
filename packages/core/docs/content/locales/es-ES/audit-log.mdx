...
- [**Actions**](/docs/actions-overview): la costura `defineAction` donde se produce la captura
- [**Human-in-the-Loop Approvals**](/docs/actions-access-control#needs-approval): actions cerrado, registrado como `denied`
