...
<Diagram id="doc-block-wwpjhp" title="De entrada fija a puerta desplegable" summary={"En realidad, el corredor ejecuta el ciclo del agente en cada caso, califica la salida y sale con un valor distinto de cero si algún puntaje cae por debajo del umbral, lo que la convierte en una puerta de CI directa."}>
...
<div class="eval-flow">
  ...
  <div class="diagram-node">
    Ejecutar el bucle del agente<br /><small class="diagram-muted"
...
<Diagram id="doc-block-1udflw2" title="El proceso de anotador de 4 pasos" summary={"preprocesar y analizar la identidad predeterminada; solo se requiere generateScore. analizar puede ejecutar JS simple o llamar a un juez LLM a través de ctx."}>
...
- [**Actions**](/docs/actions-overview): las herramientas/actions que aparecen en `toolCalls`
