...
La idea que define Agent-Native es que el agente y el UI son **socios iguales**; consulte [¿Qué es Agent-Native?](/docs/what-is-agent-native) para conocer el razonamiento. Esta sección trata sobre la otra mitad de esa promesa: cómo se siente trabajar realmente con el agente una vez que está acoplado junto a su aplicación.
