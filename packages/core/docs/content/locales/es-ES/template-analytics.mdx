...
<WireframeBlock id="doc-block-1r13485">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-h78w5w" title="Pregunta para graficar" summary={"El agente consulta el diccionario de datos, escribe SQL, lo valida con el almacén y luego genera un gráfico o guarda un panel."}>

```html
<div class="diagram-flow">
  <div class="diagram-node">Lenguaje claro<br />question</div>
  ...
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>Escribe SQL</div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-pill ok">Validar en modo dry-run</div>
    <small class="diagram-muted">BigQuery / fuente</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box">Gráfico, tabla o<br />saved panel</div>
</div>
```
...
<DataModel
  id="doc-block-1m98uos"
  title="Modelo de datos Analytics"
  summary={
    "Dashboards y análisis son los recursos; vistas, compartidos y una caché de consultas cuelgan de ellos. Las tablas de organización provienen de @agent-native/core/org."
  }
  entities={[
    {
      id: "dashboards",
      ...
      fields: [
        ...
        },
        {
          name: "config",
          type: "text",
          note: "JSON que coincide con SqlDashboardConfig",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "instructions",
          type: "text",
          note: "Volver a ejecutar los pasos",
        },
        {
          name: "dataSources",
          type: "text",
          note: "Fuentes tocadas",
        },
        {
          name: "resultMarkdown",
          type: "text",
...
Para conocer un patrón más amplio sobre cómo ampliar plantillas, consulte [Skills guide](/docs/skills-guide) y [Actions](/docs/actions-overview).
