...
- **Visor**: solo lectura.
- **Comentarista**: puede leer y añadir comentarios, pero no editar el recurso ni administrar el acceso.
...
- **Aplicaciones de datos personales** como el correo: diseñadas para el usuario. No existe el concepto de "compartir mi bandeja de entrada".
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "role",
          type: "enum",
          note: "visor | comentarista | redactor | administración",
        },
        {
          name: "created_by",
          type: "text",
