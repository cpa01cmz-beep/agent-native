...
description: "Edición colaborativa multiusuario donde el agente de IA es un par de primera clase: fusión CRDT, presencia en vivo, ruta rápida SSE y fusión granular del lado del servidor, en PostgreSQL/PGlite y cualquier host."
---
...
- **Funciona en todas partes**: PostgreSQL/PGlite.
...
La tabla está administrada por el marco y es independiente del proveedor (uso PGlite y Postgres
...
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Postgres en un host accesible públicamente**                             | La puerta de enlace marca la base de datos desde su propia red. PGlite, `localhost`, `*.internal` y las direcciones IP desnudas se rechazan antes de que la cadena de conexión de PostgreSQL salga siquiera de tu máquina. | `DATABASE_URL` apunta a un Postgres gestionado como Neon                                                                                                                                                      |
...
canal. La aplicación envía su cadena de conexión de PostgreSQL y su origen público, recibe un
...
**El autorregistro implica enviar a Builder la cadena de conexión de PostgreSQL de tu base de
