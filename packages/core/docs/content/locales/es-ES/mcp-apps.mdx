...
<Diagram id="doc-block-a9tqpc" title={"MCP Aplicación integrada de ida y vuelta"} summary={"El destino del enlace de la acción también es el destino de inserción. Los hosts compatibles cargan la misma ruta de aplicación firmada en línea; todos los demás recurren al enlace profundo."}>
...
<div class="diagram-embed">
  ...
  <div class="diagram-card" data-rough>
    ...
    ><small class="diagram-muted">intercambia ticket SQL de un solo uso</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card" data-rough>
    <strong>Signed app route</strong
    ><span class="diagram-pill ok">ruta React real</span
    ><small class="diagram-muted">short-lived browser session</small>
  </div>
  <div class="diagram-fallback">
    <span class="diagram-pill warn">sin soporte para MCP Apps</span>
...
<AnnotatedCode
  id="doc-block-1c5jqad"
  title={"La configuración del recurso mcpApp"}
  ...
  annotations={[
    {
      ...
      note: "`mcpApp.resource` anuncia una interfaz de usuario en línea para hosts que admiten la extensión de aplicaciones MCP. Mantenga también el generador `link` de la acción: los hosts anteriores y exclusivos para CLI ignoran los metadatos de la interfaz de usuario y aún necesitan el enlace profundo.",
    },
    {
      lines: "7",
    ...
    {
      lines: "11",
      label: "Etiqueta de reserva universal",
      note: '`openLabel` es el texto visible `"Open in … →"` que se usa como salida de enlace profundo cuando un host no renderiza el iframe en línea.',
    },
  ]}
/>
...
<div class="diagram-bridge">
  <div class="diagram-col">
    <div class="diagram-card" data-rough>
      ...
      ><small class="diagram-muted"
        >hidrata HTML firmado de la app en el iframe de Claude y luego usa el
        puente de host directo `ui/_`</small
      >
    </div>
    <div class="diagram-card" data-rough>
  ...
  <div class="diagram-box" data-rough>
    Same signed app route<br /><small class="diagram-muted"
      >ruta normal + componentes React</small
    >
  </div>
</div>
```
...
- [Actions](/docs/actions-overview) — `defineAction`, el constructor de `link`, `publicAgent`.
