...
- [**Actions**](/docs/actions-overview) – die Tools, die Ihr reiner Agent aufrufen wird

Verwenden Sie für eine neue Headless-App `npx --yes @agent-native/core@latest create my-agent --headless`.
