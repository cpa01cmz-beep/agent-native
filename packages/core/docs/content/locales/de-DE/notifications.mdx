...
<Diagram id="doc-block-1hnxjg1" title="Ein Anruf, viele Ziele" summary={"notify() schreibt immer die inhaberbezogene Posteingangszeile, verteilt sie parallel an alle registrierten Kanäle (Best-Effort) und gibt dann notification.sent auf dem Ereignisbus aus."}>
...
<div class="diagram-channels">
  ...
  <div class="diagram-panel col" data-rough>
    <strong>Schweregrad steuert das Badge</strong>
    <div class="sev-row">
      <span class="diagram-pill">info</span
      ><span class="diagram-muted">Bestätigungen, FYI</span>
    </div>
    <div class="sev-row">
...
- **Umfrageintegration** – jede Mutation ruft `recordChange()` auf, sodass Vorlagen, die [`useDbSync`](/docs/client-data#usedbsync) verwenden, ohne zusätzliche Verkabelung automatisch ungültig werden.
...
- [**Server plugins**](/docs/server-overview) – wo benutzerdefinierte Kanäle beim Start registriert werden
