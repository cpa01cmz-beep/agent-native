...
<Diagram id="doc-block-n5a5vk" title={"Hinzufügen druckt ein Rezept; Ihr Codierungsagent wendet es an"} summary={"agent-native gibt einen Markdown-Blueprint an stdout aus (Diagnose an stderr); Sie leiten es an Claude Code oder Codex weiter, wodurch Ihr Live-Repository mit vollständigem Kontext bearbeitet wird."}>
...
<div class="diagram-bp">
  ...
  <div class="diagram-box" data-rough>
    Markdown-Blueprint<br /><small class="diagram-muted"
      >stdout · zu ändernde Dateien · Regeln · Verifizieren</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
...
agent-native add <kind> <https://docs…>   # Forschung und Integration von einem URL aus
...
- [**Actions**](/docs/actions-overview) – die einzige Quelle der Wahrheit, auf der jede Blaupause aufbaut
