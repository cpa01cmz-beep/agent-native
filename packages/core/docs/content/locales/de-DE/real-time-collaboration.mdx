...
description: "Kollaborative Bearbeitung durch mehrere Benutzer, bei der der KI-Agent ein erstklassiger Partner ist: CRDT-Zusammenführung, Live-Präsenz, SSE-Fast-Path und granulare serverseitige Zusammenführung – auf PostgreSQL/PGlite und jedem Host."
---
...
- **Funktioniert überall** – PostgreSQL/PGlite.
...
Die Tabelle wird vom Framework verwaltet und ist anbieterunabhängig (Verwendung von PGlite und Postgres
...
| ------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Postgres auf einem öffentlich erreichbaren Host**                | Das Gateway wählt die Datenbank aus seinem eigenen Netz an. PGlite, `localhost`, `*.internal` und nackte IP-Adressen werden abgelehnt, bevor die PostgreSQL-Verbindungszeichenfolge Ihre Maschine überhaupt verlässt. | `DATABASE_URL` zeigt auf ein verwaltetes Postgres wie Neon                                                                                                                                                                  |
...
einen Kanal benötigt. Die App sendet ihre PostgreSQL-Verbindungszeichenfolge und ihren
...
**Selbstregistrierung bedeutet, Builder Ihre PostgreSQL-Verbindungszeichenfolge
