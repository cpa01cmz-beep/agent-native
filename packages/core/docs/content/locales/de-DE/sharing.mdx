...
description: "Vertrautes, einheitliches Teilen, direkt in das Framework integriert. Jede benutzererstellte Ressource – Dokumente, Dashboards, Designs, Decks, Clips, Aufzeichnungen und Formulare – erhält dasselbe standardmäßig private Modell mit einer einheitlichen Freigabeoberfläche."
---

# Freigabe und Datenschutz

Jede Ressource, die ein Benutzer in einer agentennativen App erstellt – ein Dokument, ein Dashboard, ein Design, eine Präsentation, eine Bildschirmaufzeichnung, ein Besprechungsprotokoll, ein Formular, ein Buchungslink – ist **standardmäßig privat für den Ersteller**. Andere sehen es nur, wenn der Ersteller es ausdrücklich teilt oder seine Sichtbarkeit in `org` oder `public` ändert.

Es gibt überall ein vertrautes Freigabemodell: dieselbe Freigabeschaltfläche, derselbe Dialog, dasselbe dreistufige Sichtbarkeitsmodell und dieselben Berechtigungen pro Benutzer und Organisation – in jeder Vorlage, ohne Neuerfindung pro App.
...
<Diagram id="doc-block-888xgo" title={"Sichtbarkeit, die sich nach außen erweitert"} summary={"Grobe Sichtbarkeit auf der Ressource legt den Boden fest; Durch explizite Aktienzuteilungen in der Begleittabelle werden benannte Personen oben hinzugefügt."}>
...
- **Kommentator** – kann lesen und Kommentare hinzufügen, aber die Ressource nicht bearbeiten oder Freigaben verwalten.
...
- **Apps für persönliche Daten** (Mail) – vom Design her benutzerbezogen. Es gibt kein Konzept zum Teilen meines Posteingangs.
...
- Ein Kontrollkästchen `Personen benachrichtigen` für individuelle E-Mail-Berechtigungen.
...
<DataModel
  id="doc-block-10alyfb"
  title={"Tabelle „Ressourcen- und Begleitanteile“."}
  summary={
  ...
  entities={[
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "text",
          nullable: false,
          note: "Die einzige Quelle der Wahrheit für Eigentum.",
        },
        {
          name: "org_id",
          type: "text",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "role",
          type: "enum",
          note: "Zuschauer | Kommentator | Herausgeber | Administrator",
        },
        {
          name: "created_by",
          type: "text",
...
## Wie geht es weiter? {#see-also}

- [**Sicherheit – Datenscoping**](/docs/security#data-scoping) – das Zugriffsfilter- und Eigentumsmodell, auf dem das Teilen basiert
- [**Authentifizierung**](/docs/authentication) – Sitzungen, Organisationen und wie Identität in den Anfragekontext fließt
- [**Erweiterungen**](/docs/extensions#sharing) – Teilen in der Sandbox-Mini-App-Oberfläche
- [**Vorlagen erstellen**](/docs/creating-templates) – `ownableColumns` mit dem Schema einer neuen Vorlage verbinden
