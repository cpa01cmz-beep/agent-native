...
Assets ist ein agentennativer Arbeitsbereich zum Erstellen und Verwalten markenkonsistenter Medien, besonders wenn Bild- oder Videomodelle einen klaren Vorteil haben. Es organisiert Uploads und generierte Ergebnisse in Bibliotheken und Ordnern, ermöglicht Teams das Sammeln freigegebener Referenzen für Produktaufnahmen, Logos, Social-Media-Bilder, fotorealistische Szenen und andere Medien zur Verwendung in einer Design-Komposition oder an anderer Stelle und leitet die Generierung über den Agenten-Chat weiter, sodass jedes Asset überprüft und verfeinert werden kann.

<WireframeBlock id="doc-block-18i7owc">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-6q66nj" title={"Generieren, überprüfen, wiederverwenden"} summary={"Referenzen und Eingabeaufforderungen speisen eine Sitzung zum Generieren und Auswählen. Ausgewählte Assets landen in einer Bibliothek und fließen über den Picker oder A2A an andere Apps."}>
...
<div class="diagram-assets">
  <div class="diagram-col">
    <div class="diagram-node">
      References<br /><small class="diagram-muted"
        >Logos, Produktbilder, Stil</small
      >
    </div>
    <div class="diagram-node">
      Prompt<br /><small class="diagram-muted"
        >Chat- oder Generate-Steuerung</small
      >
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    <span class="diagram-pill accent">Generierungssitzung</span
  ...
  <div class="diagram-box" data-rough>
    ...
    ><small class="diagram-muted">ausgewählte, markenkonforme Assets</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-node">
    ...
    <div class="diagram-node">
      A2A<br /><small class="diagram-muted">Folien · Design · Inhalte</small>
    </div>
  </div>
</div>
```
...
Verwende **Design** für die meisten visuellen Arbeiten. Starte dort für Landingpages, Anzeigen, Diagramme und andere Kompositionen, wenn du HTML/CSS, ein präzises Layout, editierbare Strukturen oder den Import und Export in ein Designtool brauchst.

Verwende **Assets**, wenn Bild- oder Videomodelle besser geeignet sind und das Ergebnis als Medium verwendet werden kann, statt Stück für Stück bearbeitet zu werden. Dazu gehören fotorealistische oder pixelbasierte Bilder, Produktaufnahmen, Social-Media-Bilder und Videos. Handgezeichnete Diagramme oder Diagramme im Excalidraw-Stil können eine Ausnahme sein, wenn du das generierte Bild unverändert verwenden möchtest.

Der vorgesehene Ablauf ist, in Design zu beginnen und den Design-Agenten die unterstützende Bildgenerierung an Assets delegieren zu lassen, wenn eine PNG- oder andere Mediendatei die passende Lösung ist. Verwende das Ergebnis in der Design-Komposition oder in einer anderen App.
...
<DataModel
  id="doc-block-fqoixq"
  title="Assets Datenmodell"
  summary={
    "Bibliotheken sind der besitzbare Container; Collections, Ordner und Presets organisieren sie. Sessions steuern Generieren-und-Auswählen; Assets und Runs halten Ausgabe und Audit-Log. Tabellennamen behalten das ältere Präfix image_* bei, decken aber alle Medien ab."
  }
  entities={[
    {
      id: "library",
      name: "image_libraries",
      note: "Besitzbarer Container der obersten Ebene",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Style/category-Gruppierungen",
      fields: [
        {
          name: "library_id",
          type: "id",
    ...
    },
    {
      ...
      note: "Gespeicherte Generationsrezepte",
      fields: [
        {
          name: "media_type",
          type: "text",
    ...
    },
    {
      ...
      note: "Iteratives Generieren und Auswählen",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Kandidaten-Assets in einer Sitzung",
      fields: [
        {
          name: "session_id",
          type: "id",
    ...
    },
    {
      ...
      note: "Überwachungsprotokoll für die Generierung",
      fields: [
        {
          name: "model",
          type: "text",
