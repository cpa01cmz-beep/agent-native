...
<WireframeBlock id="doc-block-hurdk5">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-ld02nh" title="Frage zum Diagramm" summary={"Der Agent konsultiert das Datenwörterbuch, schreibt SQL, validiert es anhand des Warehouse und rendert dann ein Diagramm oder speichert ein Panel."}>

```html
<div class="diagram-flow">
  <div class="diagram-node">Klare Sprache<br />question</div>
  ...
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>Schreibt SQL</div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-pill ok">Dry-run validieren</div>
    <small class="diagram-muted">BigQuery / Quelle</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box">Diagramm, Tabelle oder<br />saved panel</div>
</div>
```
...
<DataModel
  id="doc-block-of9cf1"
  title="Analytics Datenmodell"
  summary={
    "Dashboards und Analysen sind die Ressourcen; Views, Shares und ein Query-Cache hängen daran. Organisationstabellen kommen aus @agent-native/core/org."
  }
  entities={[
    {
      id: "dashboards",
      ...
      fields: [
        ...
        },
        {
          name: "config",
          type: "text",
          note: "JSON passend zu SqlDashboardConfig",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          name: "instructions",
          type: "text",
          note: "Führen Sie die Schritte erneut aus",
        },
        {
          name: "dataSources",
          type: "text",
          note: "Quellen berührt",
        },
        {
          name: "resultMarkdown",
          type: "text",
...
Das allgemeinere Muster zum Erweitern von Vorlagen finden Sie in [Skills guide](/docs/skills-guide) und [Actions](/docs/actions-overview).
