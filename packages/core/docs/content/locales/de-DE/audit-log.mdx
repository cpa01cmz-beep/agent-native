...
- [**Actions**](/docs/actions-overview) – die `defineAction`-Naht, an der die Erfassung erfolgt
- [**Human-in-the-Loop Approvals**](/docs/actions-access-control#needs-approval) – geschlossenes actions, aufgezeichnet als `denied`
