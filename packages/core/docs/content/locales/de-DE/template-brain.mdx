...
<Diagram id="doc-block-h7jmp8" title="Von der Quelle bis zur zitierten Antwort" summary={"Das Gehirn verarbeitet genehmigte Quellen in Rohaufnahmen, destilliert dauerhafte Erinnerungen, überprüft sie und antwortet erst dann mit Zitaten."}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-box" data-rough>
    Rohaufnahmen<br /><small class="diagram-muted"
      >dedupliziert, redigiert</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    Distill<br /><small class="diagram-muted"
      >Fakten · Entscheidungen · Prozesse</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card">
  ...
  <div class="diagram-box" data-rough>
    ...
    ><small class="diagram-muted">genehmigt, atomar</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
...
<WireframeBlock id="doc-block-9wj2l9">
  <Screen
    surface="desktop"
    html={
...
keine Vektordatenbank erforderlich, daher bleibt die Vorlage über PGlite hinweg portierbar,
Postgres, Neon, hosted PostgreSQL und ähnliche Hosts. Der Anwendungsstatus spiegelt den
aktuelle Route, Filter und ausgewählte IDs, damit der Agent immer die aktuelle Route kennt
Navigation und Auswahl.

Das Schema von Brain befindet sich in `templates/brain/server/db/schema.ts`. Neun Tabellen:
...
<DataModel
  id="doc-block-19q0jla"
  title="Brain Datenmodell"
  summary={
    "Connectors erzeugen Roh-Captures; Distillation verwandelt sie in prüfbares Wissen; Vorschläge schützen sensible Einträge. Sync-Runs und die Ingest-Warteschlange verfolgen Hintergrundarbeit."
  }
  entities={[
    {
      id: "sources",
      name: "brain_sources",
      note: "Connector-Konfiguration",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Rohe Nutzlasten aufgenommen",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Destillierte Atomeinträge",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Ausstehende Überprüfungselemente",
      fields: [
        {
          name: "id",
          type: "id",
    ...
    },
    {
      ...
      note: "Audit-Protokoll synchronisieren",
      fields: [
        {
          name: "source_id",
          type: "id",
    ...
    },
    {
      ...
      note: "Hintergrunddestillationswarteschlange",
      fields: [
        {
          name: "operation",
          type: "text",
...
<Endpoint id="doc-block-1haga3j" title="Signierter Ingest-Webhook" summary={"Clips- und generische Transkript-/capture-Importe veröffentlichen einen RawCapturePayload mit einem Bearer-Token pro Quelle."} method="POST" path="/api/_agent-native/brain/ingest" summary="Importieren Sie eine Rohaufnahme aus Clips oder einer generischen Quelle" auth={"Bearer <ingestToken> issued per source via its sourceKey"} request={{
...
Nehmen Sie diese Änderungen im Entwicklungsablauf des Repositorys vor. Der
eingebettete Agent kann nur dann bei Quelländerungen helfen, wenn der Host
bewusst Repository-/Workspace-Schreibwerkzeuge bereitstellt; andernfalls
arbeitet er über Actions und Daten. Siehe
...
- [**Agent-Ressourcen**](/docs/agent-resources) – gemeinsame Ressourcen über Apps hinweg
- [**A2A Protocol**](/docs/a2a-protocol) – App-übergreifende Delegierung
- [**Vorlagen**](/docs/cloneable-saas) – das Clone-and-own-Modell und jede weitere Domain-Vorlage als Ausgangspunkt
- [**Erste Schritte**](/docs/getting-started) – die Grundlagen des Frameworks: Actions, Anwendungsstatus und Live-Synchronisierung
