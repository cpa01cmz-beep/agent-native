...
<Diagram id="doc-block-16f33ny" title="Zwei Governance-Ebenen" summary={"Git regelt den Code; Dispatch regelt die Laufzeit. Sie ergänzen sich – wiederholen Sie nicht das eine in dem anderen."}>

```html
<div class="gov">
  <div class="diagram-card">
    <span class="diagram-pill accent">Git und GitHub</span
...
Nicht jeder, der Änderungen vornehmen muss, ist mit Git vertraut. [Builder.io](https://www.builder.io?utm_source=agent-native&utm_medium=docs&utm_campaign=framework&utm_content=workspace_management) unterstützt ein visuelles Verzweigungsmodell, das Git-Zweigen unter der Haube zuordnet – nützlich für Inhalts- und Textänderungen, Layoutanpassungen, Designiterationen und A/B-Tests ohne Entwicklungsumgebung.
...
<FileTree
  id="doc-block-u2qjg2"
  title="Governance-Konfiguration im Repo"
  entries={[
    {
      path: ".github/CODEOWNERS",
      note: "Weist Reviewer automatisch je geändertem Pfad zu",
    },
    {
      path: ".github/labeler.yml",
      note: "Labelt PRs automatisch nach App",
    },
    {
      path: "pnpm-workspace.yaml",
      note: "Workspace-Ebene: breite Review",
    },
    {
      path: "package.json",
      note: "Workspace-Ebene: im Besitz des Plattformteams",
    },
  ]}
/>
...
| **Schemamigrationen**            | Plattformteam + leitender Ingenieur      | Datensicherheit, PostgreSQL-Kompatibilität                                               |
...
Informationen zum Ressourcenmodell und zu den kanonischen Pfaden finden Sie unter [Agent-Ressourcen — Global resources](/docs/agent-resources#global-resources).

## Setup-Checkliste

Für einen neuen Arbeitsbereich nach dem Ausführen von `npx --yes @agent-native/core@latest create`:
...
- [ ] Dann registrieren Sie wiederverwendbare Workspace-Verbindungen für freigegebene Anbieterkonten
      ...
      dieses Konto
- [ ] Fügen Sie über die Seite „Ressourcen“ arbeitsbereichsweite skills-, Leitplanken-Anweisungen und Marken-/Firmenreferenzressourcen hinzu. Die vollständige Ressourcenmodelltabelle und das empfohlene Starterpaket finden Sie unter [Agent-Ressourcen](/docs/agent-resources#global-resources).
