...
Die entscheidende Idee hinter Agent-Native ist, dass der Agent und der UI **gleichberechtigte Partner** sind – siehe [Was ist Agent-Native?](/docs/what-is-agent-native) für die Begründung. In diesem Abschnitt geht es um die andere Hälfte dieses Versprechens: Wie es sich anfühlt, tatsächlich mit dem Agenten zu arbeiten, sobald er neben Ihrer App angedockt ist.
...
<Diagram id="doc-block-1iso8n0" title={"Die alltägliche Schleife"} summary={"Fünf Möglichkeiten, mit einem angedockten Agenten zu arbeiten – jede davon ist eine Seite in diesem Abschnitt."}>
...
<div class="diagram-loop">
  ...
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card">
    <strong>UI-arm</strong
    ><small class="diagram-muted">chat is the product</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card accent-card">
    <span class="diagram-pill accent">Gemeinsam bearbeiten</span
    ><small class="diagram-muted">live, nebeneinander</small>
  </div>
</div>
```
