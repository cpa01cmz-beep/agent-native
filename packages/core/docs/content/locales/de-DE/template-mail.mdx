...
<WireframeBlock id="doc-block-q56c5l">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-o2xbcu" title={"Wie eine E-Mail-Anfrage abläuft"} summary={"Tastaturkürzel und Agentenaufforderungen führen dieselben Aktionen aus. E-Mail lebt in Gmail; Entwürfe, Automatisierungen und Nachverfolgung live in SQL und application_state."}>

```html
<div class="diagram-flow">
  <div class="diagram-col">
    <div class="diagram-node">
      Sie steuern<br /><small class="diagram-muted">J/K/E/R-Tastenkürzel</small>
    </div>
    <div class="diagram-node">
      Sie fragen den Agenten<br /><small class="diagram-muted"
        >"eine freundliche Absage entwerfen"</small
      >
    </div>
  </div>
  ...
  <div class="diagram-col">
    <div class="diagram-box">
      Gmail<br /><small class="diagram-muted">mehrere Konten, über OAuth</small>
    </div>
    <div class="diagram-box">
      SQL + application_state<br /><small class="diagram-muted"
        >Entwürfe · Automatisierungen · Tracking</small
      >
    </div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&#8635;</div>
  <div class="diagram-box">Posteingang aktualisiert sich live</div>
</div>
```
...
<DataModel
  id="doc-block-1mt6whl"
  title="Mail SQL Tabellen"
  summary={
    "E-Mail selbst lebt in Gmail. Die SQL-Tabellen enthalten, was Gmail nicht enthält: Entwürfe in der Warteschlange, Sendeverfolgungsereignisse und OAuth-Tokens. Einstellungen und kurzlebiger Status sind in den Speichern „settings“ und „application_state“ gespeichert."
  }
  entities={[
    {
...
Nehmen Sie diese Änderungen in Ihrem Repository- und Entwicklungsworkflow vor. Der eingebettete Agent kann nur dann bei Quelländerungen helfen, wenn der Host bewusst Repository-/Workspace-Schreibwerkzeuge bereitstellt; andernfalls arbeitet er über Actions und Daten. Siehe [Key Concepts](/docs/key-concepts#agent-modifies-code).

## Wie geht es weiter?

- [**Vorlagen**](/docs/cloneable-saas) – das Klonen-und-Besitzen-Modell und alle anderen Domänenvorlagen als Ausgangspunkt
- [**Erste Schritte**](/docs/getting-started) – die Grundlagen des Frameworks: Aktionen, Anwendungsstatus und Live-Synchronisierung
- [**Kalender**](/docs/template-calendar) – eine verwandte Domänenvorlage für Terminplanung und Buchungen
- [**Automatisierungen**](/docs/automations) – die ereignisgesteuerte Engine hinter den Regeln für die automatische Mail-Sortierung
- [**Aktionen**](/docs/actions-overview) – das Aktionssystem, das Chat, Tastenkürzel und Automatisierungen aufrufen
