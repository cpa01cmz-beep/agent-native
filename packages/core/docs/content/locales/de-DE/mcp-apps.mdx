...
<Diagram id="doc-block-1kkqpz8" title="MCP App-Einbettungs-Roundtrip" summary={"Das Linkziel der Aktion ist auch das Einbettungsziel. Fähige Hosts laden dieselbe signierte App-Route inline; Alle anderen greifen auf den Deep Link zurück."}>
...
<div class="diagram-embed">
  ...
  <div class="diagram-card" data-rough>
    ...
    ><small class="diagram-muted">tauscht einmaliges SQL-Ticket aus</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-card" data-rough>
    <strong>Signed app route</strong
    ><span class="diagram-pill ok">echte React-Route</span
    ><small class="diagram-muted">short-lived browser session</small>
  </div>
  <div class="diagram-fallback">
    <span class="diagram-pill warn">keine MCP-Apps-Unterstützung</span>
...
<AnnotatedCode
  id="doc-block-1jau3tm"
  title="Die mcpApp-Ressourcenkonfiguration"
  ...
  annotations={[
    {
      lines: "6",
      label: "Progressive Verbesserung",
      note: "`mcpApp.resource` kündigt eine Inline-Benutzeroberfläche für Hosts an, die die Apps-Erweiterung MCP unterstützen. Behalten Sie auch den `link`-Builder der Aktion bei – nur CLI-Hosts und ältere Hosts ignorieren die UI-Metadaten und benötigen weiterhin den Deep Link.",
    },
    {
      lines: "7",
    ...
    {
      lines: "11",
      label: "Universelles Fallback-Label",
      note: '`openLabel` ist der sichtbare Text `"Open in … →"`, der als Deep-Link-Ausweg dient, wenn ein Host den Inline-iframe nicht rendert.',
    },
  ]}
/>
...
<div class="diagram-bridge">
  <div class="diagram-col">
    <div class="diagram-card" data-rough>
      ...
      ><small class="diagram-muted"
        >hydratisiert signiertes App-HTML in Claudes iframe, dann direkte
        `ui/_`-Host-Bridge</small
      >
    </div>
    <div class="diagram-card" data-rough>
  ...
  <div class="diagram-box" data-rough>
    Same signed app route<br /><small class="diagram-muted"
      >normale Route + React-Komponenten</small
    >
  </div>
</div>
```
...
- [Actions](/docs/actions-overview) – `defineAction`, der `link`-Builder, `publicAgent`.
