...
<div class="eval-flow">
  ...
  <div class="diagram-node">
    Agentenschleife ausführen<br /><small class="diagram-muted"
...
<Diagram id="doc-block-q3uriz" title="Die 4-stufige Scorer-Pipeline" summary={"Identitätsvorgaben vorverarbeiten und analysieren; Es ist nur „generateScore“ erforderlich. „analysieren“ kann einfaches JS ausführen oder über ctx einen LLM-Richter aufrufen."}>
...
agent-native eval billing            # nur Dateien, deren Pfad „Billing“ enthält
...
- [**Actions**](/docs/actions-overview) – die tools/actions, die in `toolCalls` angezeigt werden
