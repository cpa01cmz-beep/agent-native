...
<Diagram id="doc-block-1lrp8dq" title={"Was für eine öffentliche Route veröffentlicht"} summary={"Ein öffentlicher Weg fächert sich in agentenfreundliche Darstellungen auf. Das Lesen der Route erfolgt getrennt vom Aufrufen von Tools – der Tool-Zugriff bleibt optional."}>

```html
<div class="diagram-web">
  <div class="diagram-box" data-rough>
    Öffentliche Route<br /><small class="diagram-muted"
  ...
  <div class="diagram-col gate">
    <span class="diagram-pill warn">Tools bleiben privat</span
...
<AnnotatedCode
  id="doc-block-lq01eq"
  title={"Auswahl einer sicheren Aktion auf der öffentlichen Oberfläche"}
  ...
  annotations={[
    ...
    {
      lines: "5-7",
      label: "Beschreiben Sie sich selbst als Sicherheit",
      note: "Markieren Sie es als schreibgeschützt, geben Sie an, ob eine Authentifizierung erforderlich ist, und kennzeichnen Sie, ob es folgenreich ist. Öffentliche MCP schließen Folgehandlungen gemäß /write aus, es sei denn, die Richtlinien erlauben dies ausdrücklich.",
    },
  ]}
/>
...
- [**Actions**](/docs/actions-overview) – So aktivieren Sie actions für das öffentliche Agentenprotokoll
