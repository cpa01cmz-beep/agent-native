...
<Diagram id="doc-block-ayy9kz" title={"CLI Adapter → Registrierung → Aktionsoberfläche"} summary={"ShellCliAdapter umschließt eine Binärdatei; CliRegistry sammelt Adapter zur Erkennung; defineAction macht einen Aufruf auf der Aktionsoberfläche des Agenten und der Benutzeroberfläche verfügbar."}>
...
- [**Actions**](/docs/actions-overview) – die Aktionsoberflächen-CLI-Adapter sind normalerweise eingepackt.
