...
| [GitHub](https://github.com/github/github-mcp-server/blob/main/docs/remote-server.md)                                                                                   | Header                 | Ready · preflight only             | `https://api.githubcopilot.com/mcp/`      | GitHub's authorization server does not support dynamic client registration, so use an `Authorization: Bearer <github-token>` header; organizations may enforce OAuth App Access Policies.                                         |
